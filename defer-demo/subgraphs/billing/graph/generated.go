...
type ComplexityRoot struct {
	Entity struct {
		...
		FindSubscriptionByID             func(childComplexity int, id string) int
		FindSubscriptionByOrgIDAndPlanID func(childComplexity int, orgID string, planID string) int
	}
	...
	Subscription struct {
		ID                func(childComplexity int) int
		InternalLedgerRef func(childComplexity int) int
		Org               func(childComplexity int) int
		OrgID             func(childComplexity int) int
		PlanID            func(childComplexity int) int
		SeatUtilization   func(childComplexity int, federationRequires map[string]any) int
...
type EntityResolver interface {
	...
	FindSubscriptionByOrgIDAndPlanID(ctx context.Context, orgID string, planID string) (*model.Subscription, error)
	FindSubscriptionByID(ctx context.Context, id string) (*model.Subscription, error)
}
type QueryResolver interface {
	Empty(ctx context.Context) (*bool, error)
}
type SubscriptionResolver interface {
	SeatUtilization(ctx context.Context, obj *model.Subscription, federationRequires map[string]any) (float64, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Entity.findInvoiceByID":
		if e.ComplexityRoot.Entity.FindInvoiceByID == nil {
			break
		}

		args, err := ec.field_Entity_findInvoiceByID_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Entity.FindInvoiceByID(childComplexity, args["id"].(string)), true
	case "Entity.findOrganizationByID":
		if e.ComplexityRoot.Entity.FindOrganizationByID == nil {
			break
		}
		...
		return e.ComplexityRoot.Entity.FindOrganizationByID(childComplexity, args["id"].(string)), true
	case "Entity.findSubscriptionByID":
		if e.ComplexityRoot.Entity.FindSubscriptionByID == nil {
			break
		}

		args, err := ec.field_Entity_findSubscriptionByID_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Entity.FindSubscriptionByID(childComplexity, args["id"].(string)), true
	case "Entity.findSubscriptionByOrgIDAndPlanID":
		if e.ComplexityRoot.Entity.FindSubscriptionByOrgIDAndPlanID == nil {
			break
		}

		args, err := ec.field_Entity_findSubscriptionByOrgIDAndPlanID_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Entity.FindSubscriptionByOrgIDAndPlanID(childComplexity, args["orgID"].(string), args["planID"].(string)), true
	...
	case "Invoice.paid":
		if e.ComplexityRoot.Invoice.Paid == nil {
			break
		}

		return e.ComplexityRoot.Invoice.Paid(childComplexity), true
	...
	case "Organization.invoices":
		if e.ComplexityRoot.Organization.Invoices == nil {
			break
		}

		return e.ComplexityRoot.Organization.Invoices(childComplexity), true
	...
	case "Organization.subscription":
		if e.ComplexityRoot.Organization.Subscription == nil {
			break
		}

		return e.ComplexityRoot.Organization.Subscription(childComplexity), true
	...
	case "Subscription.internalLedgerRef":
		if e.ComplexityRoot.Subscription.InternalLedgerRef == nil {
			break
		}

		return e.ComplexityRoot.Subscription.InternalLedgerRef(childComplexity), true
	case "Subscription.org":
		if e.ComplexityRoot.Subscription.Org == nil {
			break
		}

		return e.ComplexityRoot.Subscription.Org(childComplexity), true
	case "Subscription.orgId":
		if e.ComplexityRoot.Subscription.OrgID == nil {
			break
		}

		return e.ComplexityRoot.Subscription.OrgID(childComplexity), true
	case "Subscription.planId":
		if e.ComplexityRoot.Subscription.PlanID == nil {
			break
		}

		return e.ComplexityRoot.Subscription.PlanID(childComplexity), true
	case "Subscription.seatUtilization":
		if e.ComplexityRoot.Subscription.SeatUtilization == nil {
			break
		}

		args, err := ec.field_Subscription_seatUtilization_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Subscription.SeatUtilization(childComplexity, args["_federationRequires"].(map[string]any)), true
...
`, BuiltIn: false},
	{Name: "../federation.graphqls", Input: `# gqlgen scaffolding only (NOT part of the DESIGN §2.7 billing SDL).
# Reason: gqlgen/gqlparser treats a type literally named ` + "`" + `Subscription` + "`" + ` as the
# subscription ROOT operation unless an explicit ` + "`" + `schema {}` + "`" + ` block is present,
# which breaks federation entity generation for the ` + "`" + `Subscription` + "`" + ` entity.
# This block disables root-name inference and provides a Query root for the
# federation plugin to extend with ` + "`" + `_service` + "`" + `/` + "`" + `_entities` + "`" + `.
schema {
  query: Query
}
...
union _Entity = Invoice | Organization | Subscription

# fake type to build resolver interfaces for users to implement
type Entity {
	findInvoiceByID(id: ID!,): Invoice!
	findOrganizationByID(id: ID!,): Organization!
	findSubscriptionByOrgIDAndPlanID(orgID: ID!,planID: ID!,): Subscription!
	findSubscriptionByID(id: ID!,): Subscription!
}
...
func (ec *executionContext) childFields_Subscription(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	...
	case "orgId":
		return ec.fieldContext_Subscription_orgId(ctx, field)
	case "planId":
		return ec.fieldContext_Subscription_planId(ctx, field)
	case "status":
		return ec.fieldContext_Subscription_status(ctx, field)
	case "internalLedgerRef":
		return ec.fieldContext_Subscription_internalLedgerRef(ctx, field)
	case "seatUtilization":
		return ec.fieldContext_Subscription_seatUtilization(ctx, field)
	case "org":
		return ec.fieldContext_Subscription_org(ctx, field)
	}
...
func (ec *executionContext) field_Entity_findInvoiceByID_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
...
func (ec *executionContext) field_Entity_findSubscriptionByID_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "id",
		func(ctx context.Context, v any) (string, error) {
...
func (ec *executionContext) field_Entity_findSubscriptionByOrgIDAndPlanID_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
...
func (ec *executionContext) field_Subscription_seatUtilization_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}

	arg0, err := ec.field_Subscription_seatUtilization_argsFederationRequires(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Subscription_seatUtilization_argsFederationRequires(
	ctx context.Context,
...
func (ec *executionContext) _Entity_findInvoiceByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Entity_findInvoiceByID(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Entity().FindInvoiceByID(ctx, fc.Args["id"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Invoice) graphql.Marshaler {
			return ec.marshalNInvoice2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐInvoice(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Entity_findOrganizationByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Entity_findOrganizationByID(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
		...
		func(ctx context.Context, selections ast.SelectionSet, v *model.Organization) graphql.Marshaler {
			return ec.marshalNOrganization2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐOrganization(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Entity_findSubscriptionByOrgIDAndPlanID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Entity_findSubscriptionByOrgIDAndPlanID(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Entity().FindSubscriptionByOrgIDAndPlanID(ctx, fc.Args["orgID"].(string), fc.Args["planID"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Subscription) graphql.Marshaler {
			return ec.marshalNSubscription2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐSubscription(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_Entity_findSubscriptionByOrgIDAndPlanID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Entity",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Entity_findSubscriptionByOrgIDAndPlanID_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Entity_findSubscriptionByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Entity_findSubscriptionByID(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Entity().FindSubscriptionByID(ctx, fc.Args["id"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Subscription) graphql.Marshaler {
			return ec.marshalNSubscription2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐSubscription(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Entity_findSubscriptionByID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Entity",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Entity_findSubscriptionByID_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Organization_subscription(ctx context.Context, field graphql.CollectedField, obj *model.Organization) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Subscription) graphql.Marshaler {
			return ec.marshalOSubscription2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐSubscription(ctx, selections, v)
		},
		true,
		false,
	)
}
func (ec *executionContext) fieldContext_Organization_subscription(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Organization",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Organization_invoices(ctx context.Context, field graphql.CollectedField, obj *model.Organization) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Invoice) graphql.Marshaler {
			return ec.marshalNInvoice2ᚕᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐInvoiceᚄ(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_Organization_invoices(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Organization",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Subscription_orgId(ctx context.Context, field graphql.CollectedField, obj *model.Subscription) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Subscription_orgId(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Subscription", field, false, false, errors.New("field of type ID does not have child fields"))
}

func (ec *executionContext) _Subscription_planId(ctx context.Context, field graphql.CollectedField, obj *model.Subscription) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Subscription_planId(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Subscription", field, false, false, errors.New("field of type ID does not have child fields"))
}
...
func (ec *executionContext) _Subscription_internalLedgerRef(ctx context.Context, field graphql.CollectedField, obj *model.Subscription) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			return obj.InternalLedgerRef, nil
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v string) graphql.Marshaler {
			return ec.marshalNString2string(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Subscription_internalLedgerRef(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Subscription", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _Subscription_seatUtilization(ctx context.Context, field graphql.CollectedField, obj *model.Subscription) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Subscription().SeatUtilization(ctx, obj, fc.Args["_federationRequires"].(map[string]any))
		},
		nil,
...
func (ec *executionContext) fieldContext_Subscription_seatUtilization(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Subscription",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Subscription_seatUtilization_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Subscription_org(ctx context.Context, field graphql.CollectedField, obj *model.Subscription) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Subscription_org(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Subscription",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Entity(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "findOrganizationByID":
			...
			out.Concurrently(i, func(ctx context.Context) graphql.Marshaler { return rrm(innerCtx) })
		case "findSubscriptionByOrgIDAndPlanID":
			field := field
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Entity_findSubscriptionByOrgIDAndPlanID(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
		...
		case "findSubscriptionByID":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Entity_findSubscriptionByID(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) _Organization(ctx context.Context, sel ast.SelectionSet, obj *model.Organization) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "invoices":
			out.Values[i] = ec._Organization_invoices(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
var subscriptionImplementors = []string{"Subscription", "_Entity"}
...
func (ec *executionContext) _Subscription(ctx context.Context, sel ast.SelectionSet, obj *model.Subscription) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "orgId":
			out.Values[i] = ec._Subscription_orgId(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		case "planId":
			out.Values[i] = ec._Subscription_planId(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		case "status":
		...
		case "internalLedgerRef":
			out.Values[i] = ec._Subscription_internalLedgerRef(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		case "seatUtilization":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Subscription_seatUtilization(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
		...
		case "org":
			out.Values[i] = ec._Subscription_org(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&out.Invalids, 1)
			}
		default:
...
func (ec *executionContext) marshalNInvoice2deferdemoᚋbillingᚋgraphᚋmodelᚐInvoice(ctx context.Context, sel ast.SelectionSet, v model.Invoice) graphql.Marshaler {
	return ec._Invoice(ctx, sel, &v)
}

func (ec *executionContext) marshalNInvoice2ᚕᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐInvoiceᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Invoice) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNInvoice2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐInvoice(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNInvoice2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐInvoice(ctx context.Context, sel ast.SelectionSet, v *model.Invoice) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNOrganization2deferdemoᚋbillingᚋgraphᚋmodelᚐOrganization(ctx context.Context, sel ast.SelectionSet, v model.Organization) graphql.Marshaler {
	return ec._Organization(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrganization2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐOrganization(ctx context.Context, sel ast.SelectionSet, v *model.Organization) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNSubscription2deferdemoᚋbillingᚋgraphᚋmodelᚐSubscription(ctx context.Context, sel ast.SelectionSet, v model.Subscription) graphql.Marshaler {
	return ec._Subscription(ctx, sel, &v)
}

func (ec *executionContext) marshalNSubscription2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐSubscription(ctx context.Context, sel ast.SelectionSet, v *model.Subscription) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOSubscription2ᚖdeferdemoᚋbillingᚋgraphᚋmodelᚐSubscription(ctx context.Context, sel ast.SelectionSet, v *model.Subscription) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Subscription(ctx, sel, v)
