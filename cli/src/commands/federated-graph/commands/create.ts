...
export default (opts: BaseCommandOptions) => {
  ...
  command.action(async (name, options) => {
    ...
    switch (resp.response?.code) {
      ...
      case EnumStatusCode.ERR_ADMISSION_WEBHOOK_FAILED: {
        spinner.warn(
          'Federated Graph was created but the composition was not deployed due to admission webhook failures. Please check the errors below.',
        );
