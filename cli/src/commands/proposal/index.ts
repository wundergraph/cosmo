...
import CloseProposalCommand from './commands/close.js';
import ApproveProposalCommand from './commands/approve.js';
...
export default (opts: BaseCommandOptions) => {
  ...
  command.addCommand(CloseProposalCommand(opts));
  command.addCommand(ApproveProposalCommand(opts));
