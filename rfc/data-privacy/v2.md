...
2. If a target specifies `type: "User"` and `field: "email"` but the User type in the schema doesn't have an "email" field
                  ...
                  "targets": {
                    ...
                    "items": {
                      ...
                      "properties": {
                        ...
                        "field": {
                          "type": "string",
                          "description": "Field name to match (if omitted, all fields of the type will match)"
                        },
                        "scalar_type": {
                          "type": "string",
