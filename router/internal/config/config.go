...
type Prometheus struct {
	...
	Path       string `yaml:"path"        default:"/metrics"       envconfig:"PROMETHEUS_HTTP_PATH"   validate:"uri"`
	ListenAddr string `yaml:"listen_addr" default:"127.0.0.1:8088" envconfig:"PROMETHEUS_LISTEN_ADDR" validate:"hostname_port"`
}
...
type OpenTelemetry struct {
	...
	Endpoint    string            `yaml:"endpoint"     default:"https://cosmo-otel.wundergraph.com" envconfig:"TELEMETRY_ENDPOINT"     validate:"required"`
...
type CORS struct {
	...
	MaxAge           time.Duration `yaml:"max_age"           default:"5m"                                 envconfig:"CORS_MAX_AGE"           validate:"required,min=5m"`
}
...
type Config struct {
	...
	ControlplaneURL      string        `yaml:"controlplane_url"      default:"https://cosmo-cp.wundergraph.com" validate:"required"                                   envconfig:"CONTROLPLANE_URL"`
	...
	LogLevel             string        `yaml:"log_level"             default:"info"                             validate:"oneof=debug info warning error fatal panic" envconfig:"LOG_LEVEL"`
	...
	HealthCheckPath      string        `yaml:"health_check_path"     default:"/health"                          validate:"uri"                                        envconfig:"HEALTH_CHECK_PATH"`
	ReadinessCheckPath   string        `yaml:"readiness_check_path"  default:"/health/ready"                    validate:"uri"                                        envconfig:"READINESS_CHECK_PATH"`
	LivenessCheckPath    string        `yaml:"liveness_check_path"   default:"/health/live"                     validate:"uri"                                        envconfig:"LIVENESS_CHECK_PATH"`
	...
	RouterConfigPath string `envconfig:"ROUTER_CONFIG_PATH" validate:"omitempty,filepath" yaml:"router_config_path"`
