	...
	* Initialize base attributes from headers and other sources
	...
	if s.webSocketConfiguration != nil && s.webSocketConfiguration.Enabled {
		wsMiddleware := NewWebsocketMiddleware(ctx, WebsocketMiddlewareOptions{
			...
			ReadTimeout:            s.engineExecutionConfiguration.EpollWebsocketClientReadTimeout,
			EnableEpoll:            s.engineExecutionConfiguration.EnableEpoll,
			EpollTimeout:           s.engineExecutionConfiguration.EpollWebsocketClientPollTimeout,
			EpollConnBufferSize:    s.engineExecutionConfiguration.EpollWebsocketClientConnBufferSize,
