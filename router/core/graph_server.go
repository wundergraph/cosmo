	...
	* Initialize base attributes from headers and other sources
	...
	if s.webSocketConfiguration != nil && s.webSocketConfiguration.Enabled {
		wsMiddleware := NewWebsocketMiddleware(ctx, WebsocketMiddlewareOptions{
			...
			EnableEpoll:            s.engineExecutionConfiguration.EnableNetPoll,
			EpollTimeout:           s.engineExecutionConfiguration.WebsocketClientPollTimeout,
			EpollConnBufferSize:    s.engineExecutionConfiguration.WebsocketClientConnBufferSize,
