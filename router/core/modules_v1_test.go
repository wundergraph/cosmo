...
func TestRegisterModuleV1(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		testModuleRegistry.registerModuleV1(m1)
		testModuleRegistry.registerModuleV1(m2)

		require.Equal(t, "testModule1", testModuleRegistry.getModulesV1()[0].ID)
		require.Equal(t, "testModule2", testModuleRegistry.getModulesV1()[1].ID)
	})

	t.Run("panic if module id is empty", func(t *testing.T) {
		testModuleRegistry := newModuleRegistry()

		require.Panics(t, func() {
			testModuleRegistry.registerModuleV1(m3)
		})
	})
	...
	t.Run("panic if module new returns nil", func(t *testing.T) {
		...
		require.Panics(t, func() {
			testModuleRegistry.registerModuleV1(m4)
		})
	})
	...
	t.Run("panic if module id is not unique", func(t *testing.T) {
		...
		require.Panics(t, func() {
			testModuleRegistry.registerModuleV1(m1)
			testModuleRegistry.registerModuleV1(m5)
		})
	})
