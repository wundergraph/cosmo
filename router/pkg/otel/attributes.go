...
const (
	...
	WgQueryRootFields                  = attribute.Key("wg.operation.root_fields")
	WgQueryRootFieldAliases            = attribute.Key("wg.operation.root_fields_aliases")
	WgQueryDepthCacheHit               = attribute.Key("wg.operation.complexity_cache_hit")
