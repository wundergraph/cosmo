...
func (_mock *MockProvider) Subscribe(ctx context.Context, cfg SubscriptionEventConfiguration, updater SubscriptionEventUpdater) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, SubscriptionEventConfiguration, SubscriptionEventUpdater) error); ok {
...
func (_e *MockProvider_Expecter) Subscribe(ctx interface{}, cfg interface{}, updater interface{}) *MockProvider_Subscribe_Call {
	return &MockProvider_Subscribe_Call{Call: _e.mock.On("Subscribe", ctx, cfg, updater)}
}

func (_c *MockProvider_Subscribe_Call) Run(run func(ctx context.Context, cfg SubscriptionEventConfiguration, updater SubscriptionEventUpdater)) *MockProvider_Subscribe_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 SubscriptionEventUpdater
		if args[2] != nil {
			arg2 = args[2].(SubscriptionEventUpdater)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockProvider_Subscribe_Call) Return(err error) *MockProvider_Subscribe_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockProvider_Subscribe_Call) RunAndReturn(run func(ctx context.Context, cfg SubscriptionEventConfiguration, updater SubscriptionEventUpdater) error) *MockProvider_Subscribe_Call {
	_c.Call.Return(run)
	return _c
}
...
// NewMockSubscriptionEventUpdater creates a new instance of MockSubscriptionEventUpdater. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockSubscriptionEventUpdater(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockSubscriptionEventUpdater {
	mock := &MockSubscriptionEventUpdater{}
	mock.Mock.Test(t)
...
func (_m *MockSubscriptionEventUpdater) EXPECT() *MockSubscriptionEventUpdater_Expecter {
...
// Error provides a mock function for the type MockSubscriptionEventUpdater
func (_mock *MockSubscriptionEventUpdater) Error(data []byte) {
	_mock.Called(data)
	return
}

// MockSubscriptionEventUpdater_Error_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Error'
type MockSubscriptionEventUpdater_Error_Call struct {
	*mock.Call
}

// Error is a helper method to define mock.On call
//   - data []byte
func (_e *MockSubscriptionEventUpdater_Expecter) Error(data interface{}) *MockSubscriptionEventUpdater_Error_Call {
	return &MockSubscriptionEventUpdater_Error_Call{Call: _e.mock.On("Error", data)}
}

func (_c *MockSubscriptionEventUpdater_Error_Call) Run(run func(data []byte)) *MockSubscriptionEventUpdater_Error_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 []byte
		if args[0] != nil {
			arg0 = args[0].([]byte)
...
func (_c *MockSubscriptionEventUpdater_Error_Call) Return() *MockSubscriptionEventUpdater_Error_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockSubscriptionEventUpdater_Error_Call) RunAndReturn(run func(data []byte)) *MockSubscriptionEventUpdater_Error_Call {
	_c.Run(run)
	return _c
}
