...
// BuildDataSource provides a mock function for the type MockProviderBuilder
func (_mock *MockProviderBuilder[P, E]) BuildDataSource(data E) (PubSubDataSource, error) {
...
// MockProviderBuilder_BuildDataSource_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BuildDataSource'
type MockProviderBuilder_BuildDataSource_Call[P any, E any] struct {
	*mock.Call
}

// BuildDataSource is a helper method to define mock.On call
//   - data E
func (_e *MockProviderBuilder_Expecter[P, E]) BuildDataSource(data interface{}) *MockProviderBuilder_BuildDataSource_Call[P, E] {
	return &MockProviderBuilder_BuildDataSource_Call[P, E]{Call: _e.mock.On("BuildDataSource", data)}
}

func (_c *MockProviderBuilder_BuildDataSource_Call[P, E]) Run(run func(data E)) *MockProviderBuilder_BuildDataSource_Call[P, E] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 E
		if args[0] != nil {
			arg0 = args[0].(E)
...
func (_c *MockProviderBuilder_BuildDataSource_Call[P, E]) Return(pubSubDataSource PubSubDataSource, err error) *MockProviderBuilder_BuildDataSource_Call[P, E] {
	_c.Call.Return(pubSubDataSource, err)
	return _c
}

func (_c *MockProviderBuilder_BuildDataSource_Call[P, E]) RunAndReturn(run func(data E) (PubSubDataSource, error)) *MockProviderBuilder_BuildDataSource_Call[P, E] {
	_c.Call.Return(run)
	return _c
}
