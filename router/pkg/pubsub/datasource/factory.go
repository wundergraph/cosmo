...
func NewPlannerConfig[PB ProviderBuilder[P, E], P any, E any](providerBuilder PB, event E, providers map[string]Provider, subscriptionOnStartFns []SubscriptionOnStartFn) *PlannerConfig[PB, P, E] {
