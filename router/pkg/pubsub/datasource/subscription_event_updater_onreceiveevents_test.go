...
func TestSubscriptionEventUpdater_UpdateSubscription_WithOnReceiveEventsHooks_Success(t *testing.T) {
...
func TestSubscriptionEventUpdater_UpdateSubscriptions_WithOnReceiveEventsHooks_Error(t *testing.T) {
	mockUpdater := NewMockSubscriptionUpdater(t)
	config := &testSubscriptionEventConfig{
		providerID:   "test-provider",
		providerType: ProviderTypeNats,
...
func TestSubscriptionEventUpdater_Update_WithMultipleOnReceiveEventsHooks_Success(t *testing.T) {
	mockUpdater := NewMockSubscriptionUpdater(t)
	config := &testSubscriptionEventConfig{
		providerID:   "test-provider",
		providerType: ProviderTypeNats,
...
func TestSubscriptionEventUpdater_Update_WithMultipleOnReceiveEventsHooks_Error(t *testing.T) {
	mockUpdater := NewMockSubscriptionUpdater(t)
	config := &testSubscriptionEventConfig{
		providerID:   "test-provider",
		providerType: ProviderTypeNats,
...
func TestSubscriptionEventUpdater_Update_WithSingleOnReceiveEventsHookModification(t *testing.T) {
	mockUpdater := NewMockSubscriptionUpdater(t)
	config := &testSubscriptionEventConfig{
		providerID:   "test-provider",
		providerType: ProviderTypeNats,
...
func TestSubscriptionEventUpdater_Update_WithSingleOnReceiveEventsHookError_ClosesSubscription(t *testing.T) {
	mockUpdater := NewMockSubscriptionUpdater(t)
	config := &testSubscriptionEventConfig{
		providerID:   "test-provider",
		providerType: ProviderTypeNats,
...
func TestSubscriptionEventUpdater_Update_WithMultipleOnReceiveEventsHooksChaining(t *testing.T) {
	mockUpdater := NewMockSubscriptionUpdater(t)
	config := &testSubscriptionEventConfig{
		providerID:   "test-provider",
		providerType: ProviderTypeNats,
...
func TestSubscriptionEventUpdater_UpdateSubscription_WithOnReceiveEventsHookError_ClosesSubscription(t *testing.T) {
	testCases := []struct {
		name      string
		hookError error
	}{
