...
func (_mock *MockAdapterInterface) Publish(ctx context.Context, event PublishAndRequestEventConfiguration) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, PublishAndRequestEventConfiguration) error); ok {
...
//   - ctx context.Context
//   - event PublishAndRequestEventConfiguration
...
func (_c *MockAdapterInterface_Publish_Call) Run(run func(ctx context.Context, event PublishAndRequestEventConfiguration)) *MockAdapterInterface_Publish_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 PublishAndRequestEventConfiguration
		if args[1] != nil {
			arg1 = args[1].(PublishAndRequestEventConfiguration)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockAdapterInterface_Publish_Call) RunAndReturn(run func(ctx context.Context, event PublishAndRequestEventConfiguration) error) *MockAdapterInterface_Publish_Call {
	_c.Call.Return(run)
	return _c
}

// Request provides a mock function for the type MockAdapterInterface
func (_mock *MockAdapterInterface) Request(ctx context.Context, event PublishAndRequestEventConfiguration, w io.Writer) error {
	ret := _mock.Called(ctx, event, w)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, PublishAndRequestEventConfiguration, io.Writer) error); ok {
		r0 = returnFunc(ctx, event, w)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// MockAdapterInterface_Request_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Request'
type MockAdapterInterface_Request_Call struct {
	*mock.Call
}
...
//   - event PublishAndRequestEventConfiguration
//   - w io.Writer
func (_e *MockAdapterInterface_Expecter) Request(ctx interface{}, event interface{}, w interface{}) *MockAdapterInterface_Request_Call {
	return &MockAdapterInterface_Request_Call{Call: _e.mock.On("Request", ctx, event, w)}
}

func (_c *MockAdapterInterface_Request_Call) Run(run func(ctx context.Context, event PublishAndRequestEventConfiguration, w io.Writer)) *MockAdapterInterface_Request_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockAdapterInterface_Request_Call) Return(err error) *MockAdapterInterface_Request_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockAdapterInterface_Request_Call) RunAndReturn(run func(ctx context.Context, event PublishAndRequestEventConfiguration, w io.Writer) error) *MockAdapterInterface_Request_Call {
	_c.Call.Return(run)
	return _c
}
