...
type Prometheus struct {
	...
	EngineStats         bool       `yaml:"engine_stats" envDefault:"false" env:"PROMETHEUS_ENGINE_STATS"`
...
type MetricsOTLP struct {
	...
	EngineStats         bool                  `yaml:"engine_stats" envDefault:"false" env:"METRICS_OTLP_ENGINE_STATS"`
