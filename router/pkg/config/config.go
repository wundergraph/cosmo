...
type SecurityConfiguration struct {
	...
	DisallowInlineArguments     DisallowInlineArguments     `yaml:"disallow_inline_arguments,omitempty" envPrefix:"SECURITY_DISALLOW_INLINE_ARGUMENTS_"`
}
...
type DisallowInlineArguments struct {
	...
	EnforceHTTPStatusCode int `yaml:"enforce_http_status_code,omitempty" json:"enforce_http_status_code,omitempty" envDefault:"400" env:"ENFORCE_HTTP_STATUS_CODE"`

	// ErrorCode is the GraphQL error extensions.code emitted on rejection or annotation.
	ErrorCode string `yaml:"error_code,omitempty" json:"error_code,omitempty" envDefault:"INLINE_ARGUMENT_VALUES_NOT_ALLOWED" env:"ERROR_CODE"`
