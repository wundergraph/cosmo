...
type MCPConfiguration struct {
	...
	// OmitOperationPrefix removes the "execute_operation_" prefix from MCP tool names.
	// When true, GetUser becomes get_user. When false (default), GetUser becomes execute_operation_get_user.
