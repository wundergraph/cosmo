...
type EngineExecutionConfiguration struct {
	...
	ExecutionPlanCacheSize                 int64                    `default:"1000" envconfig:"ENGINE_EXECUTION_PLAN_CACHE_SIZE" yaml:"execution_plan_cache_size,omitempty"`
	...
	NormalizationCacheSize                 int64                    `default:"1000" envconfig:"ENGINE_NORMALIZATION_CACHE_SIZE" yaml:"normalization_cache_size,omitempty"`
}
