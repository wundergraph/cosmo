...
type GRPCMapping struct {
	...
	InputArguments map[string]*InputArgumentMap `protobuf:"bytes,2,rep,name=input_arguments,json=inputArguments,proto3" json:"input_arguments,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// QueryRPCs maps GraphQL query fields to the corresponding gRPC RPC configurations
	QueryRpcs map[string]*RPCConfig `protobuf:"bytes,3,rep,name=query_rpcs,json=queryRpcs,proto3" json:"query_rpcs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// MutationRPCs maps GraphQL mutation fields to the corresponding gRPC RPC configurations
	MutationRpcs map[string]*RPCConfig `protobuf:"bytes,4,rep,name=mutation_rpcs,json=mutationRpcs,proto3" json:"mutation_rpcs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// SubscriptionRPCs maps GraphQL subscription fields to the corresponding gRPC RPC configurations
	SubscriptionRpcs map[string]*RPCConfig `protobuf:"bytes,5,rep,name=subscription_rpcs,json=subscriptionRpcs,proto3" json:"subscription_rpcs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// EntityRPCs defines how GraphQL types are resolved as entities using specific RPCs
	EntityRpcs map[string]*EntityRPCConfig `protobuf:"bytes,6,rep,name=entity_rpcs,json=entityRpcs,proto3" json:"entity_rpcs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Fields defines the field mappings between GraphQL types and gRPC messages
	Fields map[string]*FieldMap `protobuf:"bytes,7,rep,name=fields,proto3" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *GRPCMapping) GetServices() map[string]string {
	if x != nil {
		return x.Services
	}
	return nil
...
func (x *GRPCMapping) GetInputArguments() map[string]*InputArgumentMap {
	if x != nil {
...
func (x *GRPCMapping) GetQueryRpcs() map[string]*RPCConfig {
	if x != nil {
		return x.QueryRpcs
	}
	return nil
...
func (x *GRPCMapping) GetMutationRpcs() map[string]*RPCConfig {
	if x != nil {
		return x.MutationRpcs
	}
	return nil
}

func (x *GRPCMapping) GetSubscriptionRpcs() map[string]*RPCConfig {
	if x != nil {
		return x.SubscriptionRpcs
	}
	return nil
}

func (x *GRPCMapping) GetEntityRpcs() map[string]*EntityRPCConfig {
	if x != nil {
		return x.EntityRpcs
	}
	return nil
...
func (x *GRPCMapping) GetFields() map[string]*FieldMap {
	if x != nil {
		return x.Fields
	}
	return nil
...
type InputArgumentMap struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Mappings map[string]string `protobuf:"bytes,1,rep,name=mappings,proto3" json:"mappings,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *InputArgumentMap) Reset() {
	*x = InputArgumentMap{}
	if protoimpl.UnsafeEnabled {
...
func (x *InputArgumentMap) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InputArgumentMap) ProtoMessage() {}

func (x *InputArgumentMap) ProtoReflect() protoreflect.Message {
	mi := &file_wg_cosmo_node_v1_node_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InputArgumentMap.ProtoReflect.Descriptor instead.
func (*InputArgumentMap) Descriptor() ([]byte, []int) {
	return file_wg_cosmo_node_v1_node_proto_rawDescGZIP(), []int{27}
}

func (x *InputArgumentMap) GetMappings() map[string]string {
	if x != nil {
		return x.Mappings
	}
	return nil
...
func (x *RPCConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RPCConfig) ProtoMessage() {}

func (x *RPCConfig) ProtoReflect() protoreflect.Message {
	mi := &file_wg_cosmo_node_v1_node_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *RPCConfig) GetRequest() string {
	if x != nil {
		return x.Request
	}
	return ""
...
func (x *RPCConfig) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
func (x *EntityRPCConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EntityRPCConfig) ProtoMessage() {}

func (x *EntityRPCConfig) ProtoReflect() protoreflect.Message {
	mi := &file_wg_cosmo_node_v1_node_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EntityRPCConfig.ProtoReflect.Descriptor instead.
func (*EntityRPCConfig) Descriptor() ([]byte, []int) {
	return file_wg_cosmo_node_v1_node_proto_rawDescGZIP(), []int{29}
}

func (x *EntityRPCConfig) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *EntityRPCConfig) GetRpc() string {
	if x != nil {
		return x.Rpc
	}
	return ""
...
func (x *EntityRPCConfig) GetRequest() string {
	if x != nil {
		return x.Request
	}
	return ""
...
func (x *EntityRPCConfig) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
type FieldMap struct {
	...
	Mappings map[string]*FieldMapData `protobuf:"bytes,1,rep,name=mappings,proto3" json:"mappings,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *FieldMap) GetMappings() map[string]*FieldMapData {
	if x != nil {
		return x.Mappings
	}
	return nil
...
type FieldMapData struct {
	...
	ArgumentMappings map[string]string `protobuf:"bytes,2,rep,name=argument_mappings,json=argumentMappings,proto3" json:"argument_mappings,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *FieldMapData) Reset() {
	*x = FieldMapData{}
	if protoimpl.UnsafeEnabled {
...
func (x *FieldMapData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FieldMapData) ProtoMessage() {}

func (x *FieldMapData) ProtoReflect() protoreflect.Message {
	mi := &file_wg_cosmo_node_v1_node_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FieldMapData.ProtoReflect.Descriptor instead.
func (*FieldMapData) Descriptor() ([]byte, []int) {
	return file_wg_cosmo_node_v1_node_proto_rawDescGZIP(), []int{31}
}

func (x *FieldMapData) GetTargetName() string {
	if x != nil {
		return x.TargetName
	}
	return ""
...
func (x *FieldMapData) GetArgumentMappings() map[string]string {
	if x != nil {
...
var file_wg_cosmo_node_v1_node_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x6f, 0x0a, 0x11, 0x47, 0x52, 0x50,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x6b, 0x0a, 0x0f, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x50,
	0x43, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x70, 0x63,
	...
	0x65, 0x22, 0xad, 0x01, 0x0a, 0x08, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x70, 0x12, 0x44,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x70, 0x2e, 0x4d, 0x61, 0x70,
	0x70, 0x69, 0x6e, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x08, 0x6d, 0x61, 0x70, 0x70,
	0x69, 0x6e, 0x67, 0x73, 0x1a, 0x5b, 0x0a, 0x0d, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x73,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x34, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x77, 0x67, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	...
	,
	...
	,
	...
	0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x18, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x06, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x22, 0xa8, 0x01, 0x0a, 0x18, 0x45,
	...
	0x64, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x97, 0x01, 0x0a, 0x16, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f,
	...
	0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x22,
	...
	0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x50, 0x55, 0x42, 0x53, 0x55, 0x42, 0x10, 0x02, 0x2a, 0x34,
	0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x50,
	0x55, 0x42, 0x4c, 0x49, 0x53, 0x48, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x51, 0x55,
	0x45, 0x53, 0x54, 0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x53, 0x55, 0x42, 0x53, 0x43, 0x52, 0x49,
	0x42, 0x45, 0x10, 0x02, 0x2a, 0x86, 0x01, 0x0a, 0x19, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	...
	0x32, 0x6e, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x5f, 0x0a, 0x0c, 0x53, 0x65, 0x6c, 0x66, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x77, 0x67, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x42, 0xcb, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x77, 0x67, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x09, 0x4e, 0x6f, 0x64, 0x65, 0x50,
	...
	,
...
var file_wg_cosmo_node_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
var file_wg_cosmo_node_v1_node_proto_goTypes = []any{
	...
	(*GRPCConfiguration)(nil),                 // 31: wg.cosmo.node.v1.GRPCConfiguration
	(*GRPCMapping)(nil),                       // 32: wg.cosmo.node.v1.GRPCMapping
	(*InputArgumentMap)(nil),                  // 33: wg.cosmo.node.v1.InputArgumentMap
	(*RPCConfig)(nil),                         // 34: wg.cosmo.node.v1.RPCConfig
	(*EntityRPCConfig)(nil),                   // 35: wg.cosmo.node.v1.EntityRPCConfig
	(*FieldMap)(nil),                          // 36: wg.cosmo.node.v1.FieldMap
	(*FieldMapData)(nil),                      // 37: wg.cosmo.node.v1.FieldMapData
	(*NatsStreamConfiguration)(nil),           // 38: wg.cosmo.node.v1.NatsStreamConfiguration
	(*NatsEventConfiguration)(nil),            // 39: wg.cosmo.node.v1.NatsEventConfiguration
	(*KafkaEventConfiguration)(nil),           // 40: wg.cosmo.node.v1.KafkaEventConfiguration
	(*EngineEventConfiguration)(nil),          // 41: wg.cosmo.node.v1.EngineEventConfiguration
	(*DataSourceCustomEvents)(nil),            // 42: wg.cosmo.node.v1.DataSourceCustomEvents
	(*DataSourceCustom_Static)(nil),           // 43: wg.cosmo.node.v1.DataSourceCustom_Static
	(*ConfigurationVariable)(nil),             // 44: wg.cosmo.node.v1.ConfigurationVariable
	(*DirectiveConfiguration)(nil),            // 45: wg.cosmo.node.v1.DirectiveConfiguration
	(*URLQueryConfiguration)(nil),             // 46: wg.cosmo.node.v1.URLQueryConfiguration
	(*HTTPHeader)(nil),                        // 47: wg.cosmo.node.v1.HTTPHeader
	(*MTLSConfiguration)(nil),                 // 48: wg.cosmo.node.v1.MTLSConfiguration
	(*GraphQLSubscriptionConfiguration)(nil),  // 49: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration
	(*GraphQLFederationConfiguration)(nil),    // 50: wg.cosmo.node.v1.GraphQLFederationConfiguration
	(*InternedString)(nil),                    // 51: wg.cosmo.node.v1.InternedString
	(*SingleTypeField)(nil),                   // 52: wg.cosmo.node.v1.SingleTypeField
	(*SubscriptionFieldCondition)(nil),        // 53: wg.cosmo.node.v1.SubscriptionFieldCondition
	(*SubscriptionFilterCondition)(nil),       // 54: wg.cosmo.node.v1.SubscriptionFilterCondition
	(*CacheWarmerOperations)(nil),             // 55: wg.cosmo.node.v1.CacheWarmerOperations
	(*Operation)(nil),                         // 56: wg.cosmo.node.v1.Operation
	(*OperationRequest)(nil),                  // 57: wg.cosmo.node.v1.OperationRequest
	(*Extension)(nil),                         // 58: wg.cosmo.node.v1.Extension
	(*PersistedQuery)(nil),                    // 59: wg.cosmo.node.v1.PersistedQuery
	(*ClientInfo)(nil),                        // 60: wg.cosmo.node.v1.ClientInfo
	nil,                                       // 61: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry
	nil,                                       // 62: wg.cosmo.node.v1.EngineConfiguration.StringStorageEntry
	nil,                                       // 63: wg.cosmo.node.v1.FetchConfiguration.HeaderEntry
	nil,                                       // 64: wg.cosmo.node.v1.GRPCMapping.ServicesEntry
	nil,                                       // 65: wg.cosmo.node.v1.GRPCMapping.InputArgumentsEntry
	nil,                                       // 66: wg.cosmo.node.v1.GRPCMapping.QueryRpcsEntry
	nil,                                       // 67: wg.cosmo.node.v1.GRPCMapping.MutationRpcsEntry
	nil,                                       // 68: wg.cosmo.node.v1.GRPCMapping.SubscriptionRpcsEntry
	nil,                                       // 69: wg.cosmo.node.v1.GRPCMapping.EntityRpcsEntry
	nil,                                       // 70: wg.cosmo.node.v1.GRPCMapping.FieldsEntry
	nil,                                       // 71: wg.cosmo.node.v1.InputArgumentMap.MappingsEntry
	nil,                                       // 72: wg.cosmo.node.v1.FieldMap.MappingsEntry
	nil,                                       // 73: wg.cosmo.node.v1.FieldMapData.ArgumentMappingsEntry
...
var file_wg_cosmo_node_v1_node_proto_depIdxs = []int32{
	61, // 0: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.config_by_feature_flag_name:type_name -> wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry
	...
	62, // 13: wg.cosmo.node.v1.EngineConfiguration.string_storage:type_name -> wg.cosmo.node.v1.EngineConfiguration.StringStorageEntry
	...
	43, // 18: wg.cosmo.node.v1.DataSourceConfiguration.custom_static:type_name -> wg.cosmo.node.v1.DataSourceCustom_Static
	45, // 19: wg.cosmo.node.v1.DataSourceConfiguration.directives:type_name -> wg.cosmo.node.v1.DirectiveConfiguration
	...
	42, // 23: wg.cosmo.node.v1.DataSourceConfiguration.custom_events:type_name -> wg.cosmo.node.v1.DataSourceCustomEvents
	...
	19, // 28: wg.cosmo.node.v1.AuthorizationConfiguration.required_or_scopes_by_or:type_name -> wg.cosmo.node.v1.Scopes
	18, // 29: wg.cosmo.node.v1.FieldConfiguration.arguments_configuration:type_name -> wg.cosmo.node.v1.ArgumentConfiguration
	20, // 30: wg.cosmo.node.v1.FieldConfiguration.authorization_configuration:type_name -> wg.cosmo.node.v1.AuthorizationConfiguration
	54, // 31: wg.cosmo.node.v1.FieldConfiguration.subscription_filter_condition:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	24, // 32: wg.cosmo.node.v1.FieldSetCondition.field_coordinates_path:type_name -> wg.cosmo.node.v1.FieldCoordinates
	25, // 33: wg.cosmo.node.v1.RequiredField.conditions:type_name -> wg.cosmo.node.v1.FieldSetCondition
	44, // 34: wg.cosmo.node.v1.FetchConfiguration.url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	5,  // 35: wg.cosmo.node.v1.FetchConfiguration.method:type_name -> wg.cosmo.node.v1.HTTPMethod
	63, // 36: wg.cosmo.node.v1.FetchConfiguration.header:type_name -> wg.cosmo.node.v1.FetchConfiguration.HeaderEntry
	44, // 37: wg.cosmo.node.v1.FetchConfiguration.body:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	46, // 38: wg.cosmo.node.v1.FetchConfiguration.query:type_name -> wg.cosmo.node.v1.URLQueryConfiguration
	48, // 39: wg.cosmo.node.v1.FetchConfiguration.mtls:type_name -> wg.cosmo.node.v1.MTLSConfiguration
	44, // 40: wg.cosmo.node.v1.FetchConfiguration.base_url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	44, // 41: wg.cosmo.node.v1.FetchConfiguration.path:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	44, // 42: wg.cosmo.node.v1.FetchConfiguration.http_proxy_url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	28, // 43: wg.cosmo.node.v1.DataSourceCustom_GraphQL.fetch:type_name -> wg.cosmo.node.v1.FetchConfiguration
	49, // 44: wg.cosmo.node.v1.DataSourceCustom_GraphQL.subscription:type_name -> wg.cosmo.node.v1.GraphQLSubscriptionConfiguration
	50, // 45: wg.cosmo.node.v1.DataSourceCustom_GraphQL.federation:type_name -> wg.cosmo.node.v1.GraphQLFederationConfiguration
	51, // 46: wg.cosmo.node.v1.DataSourceCustom_GraphQL.upstream_schema:type_name -> wg.cosmo.node.v1.InternedString
	52, // 47: wg.cosmo.node.v1.DataSourceCustom_GraphQL.custom_scalar_type_fields:type_name -> wg.cosmo.node.v1.SingleTypeField
	31, // 48: wg.cosmo.node.v1.DataSourceCustom_GraphQL.grpc:type_name -> wg.cosmo.node.v1.GRPCConfiguration
	32, // 49: wg.cosmo.node.v1.GRPCConfiguration.mapping:type_name -> wg.cosmo.node.v1.GRPCMapping
	64, // 50: wg.cosmo.node.v1.GRPCMapping.services:type_name -> wg.cosmo.node.v1.GRPCMapping.ServicesEntry
	65, // 51: wg.cosmo.node.v1.GRPCMapping.input_arguments:type_name -> wg.cosmo.node.v1.GRPCMapping.InputArgumentsEntry
	66, // 52: wg.cosmo.node.v1.GRPCMapping.query_rpcs:type_name -> wg.cosmo.node.v1.GRPCMapping.QueryRpcsEntry
	67, // 53: wg.cosmo.node.v1.GRPCMapping.mutation_rpcs:type_name -> wg.cosmo.node.v1.GRPCMapping.MutationRpcsEntry
	68, // 54: wg.cosmo.node.v1.GRPCMapping.subscription_rpcs:type_name -> wg.cosmo.node.v1.GRPCMapping.SubscriptionRpcsEntry
	69, // 55: wg.cosmo.node.v1.GRPCMapping.entity_rpcs:type_name -> wg.cosmo.node.v1.GRPCMapping.EntityRpcsEntry
	70, // 56: wg.cosmo.node.v1.GRPCMapping.fields:type_name -> wg.cosmo.node.v1.GRPCMapping.FieldsEntry
	71, // 57: wg.cosmo.node.v1.InputArgumentMap.mappings:type_name -> wg.cosmo.node.v1.InputArgumentMap.MappingsEntry
	72, // 58: wg.cosmo.node.v1.FieldMap.mappings:type_name -> wg.cosmo.node.v1.FieldMap.MappingsEntry
	73, // 59: wg.cosmo.node.v1.FieldMapData.argument_mappings:type_name -> wg.cosmo.node.v1.FieldMapData.ArgumentMappingsEntry
	41, // 60: wg.cosmo.node.v1.NatsEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	38, // 61: wg.cosmo.node.v1.NatsEventConfiguration.stream_configuration:type_name -> wg.cosmo.node.v1.NatsStreamConfiguration
	41, // 62: wg.cosmo.node.v1.KafkaEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	3,  // 63: wg.cosmo.node.v1.EngineEventConfiguration.type:type_name -> wg.cosmo.node.v1.EventType
	39, // 64: wg.cosmo.node.v1.DataSourceCustomEvents.nats:type_name -> wg.cosmo.node.v1.NatsEventConfiguration
	40, // 65: wg.cosmo.node.v1.DataSourceCustomEvents.kafka:type_name -> wg.cosmo.node.v1.KafkaEventConfiguration
	44, // 66: wg.cosmo.node.v1.DataSourceCustom_Static.data:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	4,  // 67: wg.cosmo.node.v1.ConfigurationVariable.kind:type_name -> wg.cosmo.node.v1.ConfigurationVariableKind
	44, // 68: wg.cosmo.node.v1.HTTPHeader.values:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	44, // 69: wg.cosmo.node.v1.MTLSConfiguration.key:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	44, // 70: wg.cosmo.node.v1.MTLSConfiguration.cert:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	44, // 71: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	75, // 72: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.protocol:type_name -> wg.cosmo.common.GraphQLSubscriptionProtocol
	76, // 73: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.websocketSubprotocol:type_name -> wg.cosmo.common.GraphQLWebsocketSubprotocol
	54, // 74: wg.cosmo.node.v1.SubscriptionFilterCondition.and:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	53, // 75: wg.cosmo.node.v1.SubscriptionFilterCondition.in:type_name -> wg.cosmo.node.v1.SubscriptionFieldCondition
	54, // 76: wg.cosmo.node.v1.SubscriptionFilterCondition.not:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	54, // 77: wg.cosmo.node.v1.SubscriptionFilterCondition.or:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	56, // 78: wg.cosmo.node.v1.CacheWarmerOperations.operations:type_name -> wg.cosmo.node.v1.Operation
	57, // 79: wg.cosmo.node.v1.Operation.request:type_name -> wg.cosmo.node.v1.OperationRequest
	60, // 80: wg.cosmo.node.v1.Operation.client:type_name -> wg.cosmo.node.v1.ClientInfo
	58, // 81: wg.cosmo.node.v1.OperationRequest.extensions:type_name -> wg.cosmo.node.v1.Extension
	59, // 82: wg.cosmo.node.v1.Extension.persisted_query:type_name -> wg.cosmo.node.v1.PersistedQuery
	8,  // 83: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry.value:type_name -> wg.cosmo.node.v1.FeatureFlagRouterExecutionConfig
	47, // 84: wg.cosmo.node.v1.FetchConfiguration.HeaderEntry.value:type_name -> wg.cosmo.node.v1.HTTPHeader
	33, // 85: wg.cosmo.node.v1.GRPCMapping.InputArgumentsEntry.value:type_name -> wg.cosmo.node.v1.InputArgumentMap
	34, // 86: wg.cosmo.node.v1.GRPCMapping.QueryRpcsEntry.value:type_name -> wg.cosmo.node.v1.RPCConfig
	34, // 87: wg.cosmo.node.v1.GRPCMapping.MutationRpcsEntry.value:type_name -> wg.cosmo.node.v1.RPCConfig
	34, // 88: wg.cosmo.node.v1.GRPCMapping.SubscriptionRpcsEntry.value:type_name -> wg.cosmo.node.v1.RPCConfig
	35, // 89: wg.cosmo.node.v1.GRPCMapping.EntityRpcsEntry.value:type_name -> wg.cosmo.node.v1.EntityRPCConfig
	36, // 90: wg.cosmo.node.v1.GRPCMapping.FieldsEntry.value:type_name -> wg.cosmo.node.v1.FieldMap
	37, // 91: wg.cosmo.node.v1.FieldMap.MappingsEntry.value:type_name -> wg.cosmo.node.v1.FieldMapData
	14, // 92: wg.cosmo.node.v1.NodeService.SelfRegister:input_type -> wg.cosmo.node.v1.SelfRegisterRequest
	15, // 93: wg.cosmo.node.v1.NodeService.SelfRegister:output_type -> wg.cosmo.node.v1.SelfRegisterResponse
...
func file_wg_cosmo_node_v1_node_proto_init() {
	...
	file_wg_cosmo_node_v1_node_proto_msgTypes[43].OneofWrappers = []any{}
	file_wg_cosmo_node_v1_node_proto_msgTypes[48].OneofWrappers = []any{}
	type x struct{}
