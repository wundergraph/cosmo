// remove generated tag so it unfolds in the PR
// versions:
...
var file_wg_cosmo_node_v1_node_proto_depIdxs = []int32{
	...
	38, // 55: wg.cosmo.node.v1.FetchConfiguration.HeaderEntry.value:type_name -> wg.cosmo.node.v1.HTTPHeader
	10, // 56: wg.cosmo.node.v1.NodeService.GetLatestValidRouterConfig:input_type -> wg.cosmo.node.v1.GetConfigRequest
	14, // 57: wg.cosmo.node.v1.NodeService.SelfRegister:input_type -> wg.cosmo.node.v1.SelfRegisterRequest
	11, // 58: wg.cosmo.node.v1.NodeService.GetLatestValidRouterConfig:output_type -> wg.cosmo.node.v1.GetConfigResponse
	15, // 59: wg.cosmo.node.v1.NodeService.SelfRegister:output_type -> wg.cosmo.node.v1.SelfRegisterResponse
