...
type GRPCConfiguration struct {
	...
	Connection  *ConnectionConfiguration `protobuf:"bytes,3,opt,name=connection,proto3" json:"connection,omitempty"`
}
...
func (x *GRPCConfiguration) GetConnection() *ConnectionConfiguration {
	if x != nil {
		return x.Connection
	}
	return nil
...
type ConnectionConfiguration struct {
	...
	//
	//	*ConnectionConfiguration_Socket
	//	*ConnectionConfiguration_Tcp
	//	*ConnectionConfiguration_Plugin
	ConnectionType isConnectionConfiguration_ConnectionType `protobuf_oneof:"connection_type"`
}
...
func (m *ConnectionConfiguration) GetConnectionType() isConnectionConfiguration_ConnectionType {
	if m != nil {
...
func (x *ConnectionConfiguration) GetSocket() *SocketConnectionConfiguration {
	if x, ok := x.GetConnectionType().(*ConnectionConfiguration_Socket); ok {
		return x.Socket
	}
	return nil
}

func (x *ConnectionConfiguration) GetTcp() *TCPConnectionConfiguration {
	if x, ok := x.GetConnectionType().(*ConnectionConfiguration_Tcp); ok {
		return x.Tcp
	}
	return nil
}

func (x *ConnectionConfiguration) GetPlugin() *PluginConnectionConfiguration {
	if x, ok := x.GetConnectionType().(*ConnectionConfiguration_Plugin); ok {
		return x.Plugin
	}
	return nil
}

type isConnectionConfiguration_ConnectionType interface {
	isConnectionConfiguration_ConnectionType()
}

type ConnectionConfiguration_Socket struct {
	// Socket connection details
	Socket *SocketConnectionConfiguration `protobuf:"bytes,1,opt,name=socket,proto3,oneof"`
}

type ConnectionConfiguration_Tcp struct {
	// TCP connection details
	Tcp *TCPConnectionConfiguration `protobuf:"bytes,2,opt,name=tcp,proto3,oneof"`
}

type ConnectionConfiguration_Plugin struct {
	// Plugin connection details
	Plugin *PluginConnectionConfiguration `protobuf:"bytes,3,opt,name=plugin,proto3,oneof"`
}

func (*ConnectionConfiguration_Socket) isConnectionConfiguration_ConnectionType() {}

func (*ConnectionConfiguration_Tcp) isConnectionConfiguration_ConnectionType() {}

func (*ConnectionConfiguration_Plugin) isConnectionConfiguration_ConnectionType() {}

type SocketConnectionConfiguration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// SSL configuration
	Ssl *SSLConfiguration `protobuf:"bytes,2,opt,name=ssl,proto3" json:"ssl,omitempty"`
}

func (x *SocketConnectionConfiguration) Reset() {
	*x = SocketConnectionConfiguration{}
	if protoimpl.UnsafeEnabled {
...
func (x *SocketConnectionConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SocketConnectionConfiguration) ProtoMessage() {}

func (x *SocketConnectionConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_wg_cosmo_node_v1_node_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SocketConnectionConfiguration.ProtoReflect.Descriptor instead.
func (*SocketConnectionConfiguration) Descriptor() ([]byte, []int) {
	return file_wg_cosmo_node_v1_node_proto_rawDescGZIP(), []int{27}
}

func (x *SocketConnectionConfiguration) GetLocation() string {
	if x != nil {
		return x.Location
	}
	return ""
...
func (x *SocketConnectionConfiguration) GetSsl() *SSLConfiguration {
	if x != nil {
		return x.Ssl
	}
	return nil
...
type TCPConnectionConfiguration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TCPConnectionConfiguration) Reset() {
	*x = TCPConnectionConfiguration{}
	if protoimpl.UnsafeEnabled {
...
func (x *TCPConnectionConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TCPConnectionConfiguration) ProtoMessage() {}

func (x *TCPConnectionConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_wg_cosmo_node_v1_node_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TCPConnectionConfiguration.ProtoReflect.Descriptor instead.
func (*TCPConnectionConfiguration) Descriptor() ([]byte, []int) {
	return file_wg_cosmo_node_v1_node_proto_rawDescGZIP(), []int{28}
}

func (x *TCPConnectionConfiguration) GetLocation() string {
	if x != nil {
		return x.Location
	}
	return ""
...
func (x *TCPConnectionConfiguration) GetSsl() *SSLConfiguration {
	if x != nil {
		return x.Ssl
	}
	return nil
...
type PluginConnectionConfiguration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PluginConnectionConfiguration) Reset() {
	*x = PluginConnectionConfiguration{}
	if protoimpl.UnsafeEnabled {
...
func (x *PluginConnectionConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PluginConnectionConfiguration) ProtoMessage() {}

func (x *PluginConnectionConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_wg_cosmo_node_v1_node_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PluginConnectionConfiguration.ProtoReflect.Descriptor instead.
func (*PluginConnectionConfiguration) Descriptor() ([]byte, []int) {
	return file_wg_cosmo_node_v1_node_proto_rawDescGZIP(), []int{29}
}

func (x *PluginConnectionConfiguration) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_wg_cosmo_node_v1_node_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0xba, 0x01, 0x0a, 0x11, 0x47, 0x52,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x49, 0x0a, 0x0a, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x31, 0x2e, 0x45, 0x6e, 0x75, 0x6d, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52, 0x0c,
	0x65, 0x6e, 0x75, 0x6d, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x73, 0x22, 0xb1, 0x01, 0x0a,
	0x10, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e,
	0x67, 0x12, 0x33, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e,
	0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e,
	0x61, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x61, 0x70, 0x70, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x6d, 0x61, 0x70, 0x70, 0x65, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65,
	...
	0x22, 0x9a, 0x01, 0x0a, 0x0d, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x4d, 0x61, 0x70, 0x70, 0x69,
	0x6e, 0x67, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x70, 0x63, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x72, 0x70, 0x63, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	0x64, 0x12, 0x4e, 0x0a, 0x11, 0x61, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6d, 0x61,
	0x70, 0x70, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x77,
	0x67, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x41, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52,
	0x10, 0x61, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67,
	0x73, 0x22, 0x45, 0x0a, 0x0f, 0x41, 0x72, 0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x61, 0x70,
	...
	,
	...
	0x9f, 0x01, 0x0a, 0x17, 0x4e, 0x61, 0x74, 0x73, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x43, 0x6f,
	...
	0x65, 0x12, 0x3e, 0x0a, 0x1b, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x5f, 0x69, 0x6e,
	0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x19, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72,
	0x49, 0x6e, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c,
	0x64, 0x22, 0xfc, 0x01, 0x0a, 0x16, 0x4e, 0x61, 0x74, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x68, 0x0a, 0x1a,
	0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x63, 0x6f, 0x6e,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x18, 0x65, 0x6e,
	0x67, 0x69, 0x6e, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63,
	0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63,
	0x74, 0x73, 0x12, 0x5c, 0x0a, 0x14, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f, 0x63, 0x6f, 0x6e,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x4e, 0x61, 0x74, 0x73, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x43, 0x6f,
	...
	0x22, 0x9b, 0x01, 0x0a, 0x17, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x68, 0x0a, 0x1a,
	0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x2a, 0x2e, 0x77, 0x67, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x2e, 0x6e, 0x6f, 0x64, 0x65,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x18, 0x65, 0x6e,
	0x67, 0x69, 0x6e, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x22, 0xa8,
	...
	0x66, 0x69, 0x65, 0x6c, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x97, 0x01, 0x0a, 0x16, 0x44, 0x61,
	...
	0x66, 0x6b, 0x61, 0x22, 0x56, 0x0a, 0x17, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x79, 0x22, 0xfb, 0x02, 0x0a, 0x20, 0x47, 0x72, 0x61, 0x70, 0x68, 0x51, 0x4c, 0x53, 0x75, 0x62,
	...
	,
	...
	,
	...
	0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x48,
	0x01, 0x52, 0x03, 0x6e, 0x6f, 0x74, 0x88, 0x01, 0x01, 0x12, 0x3d, 0x0a, 0x02, 0x6f, 0x72, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x77, 0x67, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x02, 0x6f, 0x72, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x6e, 0x42,
	0x06, 0x0a, 0x04, 0x5f, 0x6e, 0x6f, 0x74, 0x22, 0x54, 0x0a, 0x15, 0x43, 0x61, 0x63, 0x68, 0x65,
	0x57, 0x61, 0x72, 0x6d, 0x65, 0x72, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	...
	0x6e, 0x52, 0x0a, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x7f, 0x0a,
	0x09, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3c, 0x0a, 0x07, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x77, 0x67,
	...
	0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x34, 0x0a, 0x06, 0x63, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x77, 0x67, 0x2e, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x8c,
	...
	,
	...
	0x5f, 0x41, 0x52, 0x47, 0x55, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x01, 0x2a, 0x35, 0x0a, 0x0e, 0x44,
	...
	0x10, 0x02, 0x2a, 0x3a, 0x0a, 0x0d, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54,
	...
	0x53, 0x55, 0x42, 0x53, 0x43, 0x52, 0x49, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x02, 0x2a, 0x34,
...
var file_wg_cosmo_node_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_wg_cosmo_node_v1_node_proto_goTypes = []any{
	...
	(*ConnectionConfiguration)(nil),           // 33: wg.cosmo.node.v1.ConnectionConfiguration
	(*SocketConnectionConfiguration)(nil),     // 34: wg.cosmo.node.v1.SocketConnectionConfiguration
	(*TCPConnectionConfiguration)(nil),        // 35: wg.cosmo.node.v1.TCPConnectionConfiguration
	(*PluginConnectionConfiguration)(nil),     // 36: wg.cosmo.node.v1.PluginConnectionConfiguration
	(*SSLConfiguration)(nil),                  // 37: wg.cosmo.node.v1.SSLConfiguration
	(*GRPCMapping)(nil),                       // 38: wg.cosmo.node.v1.GRPCMapping
	(*OperationMapping)(nil),                  // 39: wg.cosmo.node.v1.OperationMapping
	(*EntityMapping)(nil),                     // 40: wg.cosmo.node.v1.EntityMapping
	(*TypeFieldMapping)(nil),                  // 41: wg.cosmo.node.v1.TypeFieldMapping
	(*FieldMapping)(nil),                      // 42: wg.cosmo.node.v1.FieldMapping
	(*ArgumentMapping)(nil),                   // 43: wg.cosmo.node.v1.ArgumentMapping
	(*EnumMapping)(nil),                       // 44: wg.cosmo.node.v1.EnumMapping
	(*EnumValueMapping)(nil),                  // 45: wg.cosmo.node.v1.EnumValueMapping
	(*NatsStreamConfiguration)(nil),           // 46: wg.cosmo.node.v1.NatsStreamConfiguration
	(*NatsEventConfiguration)(nil),            // 47: wg.cosmo.node.v1.NatsEventConfiguration
	(*KafkaEventConfiguration)(nil),           // 48: wg.cosmo.node.v1.KafkaEventConfiguration
	(*EngineEventConfiguration)(nil),          // 49: wg.cosmo.node.v1.EngineEventConfiguration
	(*DataSourceCustomEvents)(nil),            // 50: wg.cosmo.node.v1.DataSourceCustomEvents
	(*DataSourceCustom_Static)(nil),           // 51: wg.cosmo.node.v1.DataSourceCustom_Static
	(*ConfigurationVariable)(nil),             // 52: wg.cosmo.node.v1.ConfigurationVariable
	(*DirectiveConfiguration)(nil),            // 53: wg.cosmo.node.v1.DirectiveConfiguration
	(*URLQueryConfiguration)(nil),             // 54: wg.cosmo.node.v1.URLQueryConfiguration
	(*HTTPHeader)(nil),                        // 55: wg.cosmo.node.v1.HTTPHeader
	(*MTLSConfiguration)(nil),                 // 56: wg.cosmo.node.v1.MTLSConfiguration
	(*GraphQLSubscriptionConfiguration)(nil),  // 57: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration
	(*GraphQLFederationConfiguration)(nil),    // 58: wg.cosmo.node.v1.GraphQLFederationConfiguration
	(*InternedString)(nil),                    // 59: wg.cosmo.node.v1.InternedString
	(*SingleTypeField)(nil),                   // 60: wg.cosmo.node.v1.SingleTypeField
	(*SubscriptionFieldCondition)(nil),        // 61: wg.cosmo.node.v1.SubscriptionFieldCondition
	(*SubscriptionFilterCondition)(nil),       // 62: wg.cosmo.node.v1.SubscriptionFilterCondition
	(*CacheWarmerOperations)(nil),             // 63: wg.cosmo.node.v1.CacheWarmerOperations
	(*Operation)(nil),                         // 64: wg.cosmo.node.v1.Operation
	(*OperationRequest)(nil),                  // 65: wg.cosmo.node.v1.OperationRequest
	(*Extension)(nil),                         // 66: wg.cosmo.node.v1.Extension
	(*PersistedQuery)(nil),                    // 67: wg.cosmo.node.v1.PersistedQuery
	(*ClientInfo)(nil),                        // 68: wg.cosmo.node.v1.ClientInfo
	nil,                                       // 69: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry
	nil,                                       // 70: wg.cosmo.node.v1.EngineConfiguration.StringStorageEntry
	nil,                                       // 71: wg.cosmo.node.v1.FetchConfiguration.HeaderEntry
	(common.EnumStatusCode)(0),                // 72: wg.cosmo.common.EnumStatusCode
	(common.GraphQLSubscriptionProtocol)(0),   // 73: wg.cosmo.common.GraphQLSubscriptionProtocol
	(common.GraphQLWebsocketSubprotocol)(0),   // 74: wg.cosmo.common.GraphQLWebsocketSubprotocol
}
var file_wg_cosmo_node_v1_node_proto_depIdxs = []int32{
	69, // 0: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.config_by_feature_flag_name:type_name -> wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry
	...
	72, // 6: wg.cosmo.node.v1.Response.code:type_name -> wg.cosmo.common.EnumStatusCode
	...
	70, // 13: wg.cosmo.node.v1.EngineConfiguration.string_storage:type_name -> wg.cosmo.node.v1.EngineConfiguration.StringStorageEntry
	...
	51, // 18: wg.cosmo.node.v1.DataSourceConfiguration.custom_static:type_name -> wg.cosmo.node.v1.DataSourceCustom_Static
	53, // 19: wg.cosmo.node.v1.DataSourceConfiguration.directives:type_name -> wg.cosmo.node.v1.DirectiveConfiguration
	...
	50, // 23: wg.cosmo.node.v1.DataSourceConfiguration.custom_events:type_name -> wg.cosmo.node.v1.DataSourceCustomEvents
	...
	62, // 31: wg.cosmo.node.v1.FieldConfiguration.subscription_filter_condition:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	...
	52, // 34: wg.cosmo.node.v1.FetchConfiguration.url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	6,  // 35: wg.cosmo.node.v1.FetchConfiguration.method:type_name -> wg.cosmo.node.v1.HTTPMethod
	71, // 36: wg.cosmo.node.v1.FetchConfiguration.header:type_name -> wg.cosmo.node.v1.FetchConfiguration.HeaderEntry
	52, // 37: wg.cosmo.node.v1.FetchConfiguration.body:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	54, // 38: wg.cosmo.node.v1.FetchConfiguration.query:type_name -> wg.cosmo.node.v1.URLQueryConfiguration
	56, // 39: wg.cosmo.node.v1.FetchConfiguration.mtls:type_name -> wg.cosmo.node.v1.MTLSConfiguration
	52, // 40: wg.cosmo.node.v1.FetchConfiguration.base_url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	52, // 41: wg.cosmo.node.v1.FetchConfiguration.path:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	52, // 42: wg.cosmo.node.v1.FetchConfiguration.http_proxy_url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	29, // 43: wg.cosmo.node.v1.DataSourceCustom_GraphQL.fetch:type_name -> wg.cosmo.node.v1.FetchConfiguration
	57, // 44: wg.cosmo.node.v1.DataSourceCustom_GraphQL.subscription:type_name -> wg.cosmo.node.v1.GraphQLSubscriptionConfiguration
	58, // 45: wg.cosmo.node.v1.DataSourceCustom_GraphQL.federation:type_name -> wg.cosmo.node.v1.GraphQLFederationConfiguration
	59, // 46: wg.cosmo.node.v1.DataSourceCustom_GraphQL.upstream_schema:type_name -> wg.cosmo.node.v1.InternedString
	60, // 47: wg.cosmo.node.v1.DataSourceCustom_GraphQL.custom_scalar_type_fields:type_name -> wg.cosmo.node.v1.SingleTypeField
	32, // 48: wg.cosmo.node.v1.DataSourceCustom_GraphQL.grpc:type_name -> wg.cosmo.node.v1.GRPCConfiguration
	38, // 49: wg.cosmo.node.v1.GRPCConfiguration.mapping:type_name -> wg.cosmo.node.v1.GRPCMapping
	33, // 50: wg.cosmo.node.v1.GRPCConfiguration.connection:type_name -> wg.cosmo.node.v1.ConnectionConfiguration
	34, // 51: wg.cosmo.node.v1.ConnectionConfiguration.socket:type_name -> wg.cosmo.node.v1.SocketConnectionConfiguration
	35, // 52: wg.cosmo.node.v1.ConnectionConfiguration.tcp:type_name -> wg.cosmo.node.v1.TCPConnectionConfiguration
	36, // 53: wg.cosmo.node.v1.ConnectionConfiguration.plugin:type_name -> wg.cosmo.node.v1.PluginConnectionConfiguration
	37, // 54: wg.cosmo.node.v1.SocketConnectionConfiguration.ssl:type_name -> wg.cosmo.node.v1.SSLConfiguration
	37, // 55: wg.cosmo.node.v1.TCPConnectionConfiguration.ssl:type_name -> wg.cosmo.node.v1.SSLConfiguration
	39, // 56: wg.cosmo.node.v1.GRPCMapping.operation_mappings:type_name -> wg.cosmo.node.v1.OperationMapping
	40, // 57: wg.cosmo.node.v1.GRPCMapping.entity_mappings:type_name -> wg.cosmo.node.v1.EntityMapping
	41, // 58: wg.cosmo.node.v1.GRPCMapping.type_field_mappings:type_name -> wg.cosmo.node.v1.TypeFieldMapping
	44, // 59: wg.cosmo.node.v1.GRPCMapping.enum_mappings:type_name -> wg.cosmo.node.v1.EnumMapping
	3,  // 60: wg.cosmo.node.v1.OperationMapping.type:type_name -> wg.cosmo.node.v1.OperationType
	42, // 61: wg.cosmo.node.v1.TypeFieldMapping.field_mappings:type_name -> wg.cosmo.node.v1.FieldMapping
	43, // 62: wg.cosmo.node.v1.FieldMapping.argument_mappings:type_name -> wg.cosmo.node.v1.ArgumentMapping
	45, // 63: wg.cosmo.node.v1.EnumMapping.values:type_name -> wg.cosmo.node.v1.EnumValueMapping
	49, // 64: wg.cosmo.node.v1.NatsEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	46, // 65: wg.cosmo.node.v1.NatsEventConfiguration.stream_configuration:type_name -> wg.cosmo.node.v1.NatsStreamConfiguration
	49, // 66: wg.cosmo.node.v1.KafkaEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	4,  // 67: wg.cosmo.node.v1.EngineEventConfiguration.type:type_name -> wg.cosmo.node.v1.EventType
	47, // 68: wg.cosmo.node.v1.DataSourceCustomEvents.nats:type_name -> wg.cosmo.node.v1.NatsEventConfiguration
	48, // 69: wg.cosmo.node.v1.DataSourceCustomEvents.kafka:type_name -> wg.cosmo.node.v1.KafkaEventConfiguration
	52, // 70: wg.cosmo.node.v1.DataSourceCustom_Static.data:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	5,  // 71: wg.cosmo.node.v1.ConfigurationVariable.kind:type_name -> wg.cosmo.node.v1.ConfigurationVariableKind
	52, // 72: wg.cosmo.node.v1.HTTPHeader.values:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	52, // 73: wg.cosmo.node.v1.MTLSConfiguration.key:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	52, // 74: wg.cosmo.node.v1.MTLSConfiguration.cert:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	52, // 75: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	73, // 76: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.protocol:type_name -> wg.cosmo.common.GraphQLSubscriptionProtocol
	74, // 77: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.websocketSubprotocol:type_name -> wg.cosmo.common.GraphQLWebsocketSubprotocol
	62, // 78: wg.cosmo.node.v1.SubscriptionFilterCondition.and:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	61, // 79: wg.cosmo.node.v1.SubscriptionFilterCondition.in:type_name -> wg.cosmo.node.v1.SubscriptionFieldCondition
	62, // 80: wg.cosmo.node.v1.SubscriptionFilterCondition.not:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	62, // 81: wg.cosmo.node.v1.SubscriptionFilterCondition.or:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	64, // 82: wg.cosmo.node.v1.CacheWarmerOperations.operations:type_name -> wg.cosmo.node.v1.Operation
	65, // 83: wg.cosmo.node.v1.Operation.request:type_name -> wg.cosmo.node.v1.OperationRequest
	68, // 84: wg.cosmo.node.v1.Operation.client:type_name -> wg.cosmo.node.v1.ClientInfo
	66, // 85: wg.cosmo.node.v1.OperationRequest.extensions:type_name -> wg.cosmo.node.v1.Extension
	67, // 86: wg.cosmo.node.v1.Extension.persisted_query:type_name -> wg.cosmo.node.v1.PersistedQuery
	9,  // 87: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry.value:type_name -> wg.cosmo.node.v1.FeatureFlagRouterExecutionConfig
	55, // 88: wg.cosmo.node.v1.FetchConfiguration.HeaderEntry.value:type_name -> wg.cosmo.node.v1.HTTPHeader
	15, // 89: wg.cosmo.node.v1.NodeService.SelfRegister:input_type -> wg.cosmo.node.v1.SelfRegisterRequest
	16, // 90: wg.cosmo.node.v1.NodeService.SelfRegister:output_type -> wg.cosmo.node.v1.SelfRegisterResponse
...
func file_wg_cosmo_node_v1_node_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_wg_cosmo_node_v1_node_proto_msgTypes[26].Exporter = func(v any, i int) any {
			switch v := v.(*ConnectionConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_wg_cosmo_node_v1_node_proto_msgTypes[27].Exporter = func(v any, i int) any {
			switch v := v.(*SocketConnectionConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_wg_cosmo_node_v1_node_proto_msgTypes[28].Exporter = func(v any, i int) any {
			switch v := v.(*TCPConnectionConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_wg_cosmo_node_v1_node_proto_msgTypes[29].Exporter = func(v any, i int) any {
			switch v := v.(*PluginConnectionConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_wg_cosmo_node_v1_node_proto_msgTypes[26].OneofWrappers = []any{
		(*ConnectionConfiguration_Socket)(nil),
		(*ConnectionConfiguration_Tcp)(nil),
		(*ConnectionConfiguration_Plugin)(nil),
	}
	file_wg_cosmo_node_v1_node_proto_msgTypes[50].OneofWrappers = []any{}
