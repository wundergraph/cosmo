...
var file_wg_cosmo_node_v1_node_proto_goTypes = []any{
	...
	(*RedisEventConfiguration)(nil),           // 34: wg.cosmo.node.v1.RedisEventConfiguration
...
var file_wg_cosmo_node_v1_node_proto_depIdxs = []int32{
	...
	35, // 50: wg.cosmo.node.v1.RedisEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	...
	34, // 54: wg.cosmo.node.v1.DataSourceCustomEvents.redis:type_name -> wg.cosmo.node.v1.RedisEventConfiguration
