...
func (ec *executionContext) _Entity_findArticleByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNArticle2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚋrouterᚑtestsᚋentity_cachingᚋsubgraphsᚋarticlesmetaᚋsubgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2githubᚗcomᚋwundergraphᚋcosmoᚋrouterᚑtestsᚋentity_cachingᚋsubgraphsᚋarticlesmetaᚋsubgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v model.Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚋrouterᚑtestsᚋentity_cachingᚋsubgraphsᚋarticlesmetaᚋsubgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
