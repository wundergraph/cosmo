...
import (
	"encoding/json"
	pre_handler_module "github.com/wundergraph/cosmo/router-tests/modules/pre-handler-module"
...
func TestPreHanderHook(t *testing.T) {
	...
	t.Run("Test router normal flow works with prehandler hook", func(t *testing.T) {
		...
		cfg := config.Config{
			...
			Modules: map[string]interface{}{
				"prehandlerModule": pre_handler_module.PreHandlerModule{},
			},
		}
	...
	t.Run("Test prehandler hook is called with auth", func(t *testing.T) {
		t.Parallel()
