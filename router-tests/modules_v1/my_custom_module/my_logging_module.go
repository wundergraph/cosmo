...
func (m *MyOverwriteResponseModule) OnRouterRequest(ctx context.Context, params *core.RouterRequestParams) error {
    params.Logger.Info("Incoming /graphql request", zap.String("method", params.HttpRequest.Method))

    return nil
}

func (m *MyOverwriteResponseModule) OnRouterResponse(ctx context.Context, params *core.RouterResponseParams, exitErr *core.ExitError) error {
