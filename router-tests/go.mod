...
require (
	...
	github.com/wundergraph/cosmo/demo v0.0.0-20241025123916-0b1fceece808
	github.com/wundergraph/cosmo/router v0.0.0-20241025123916-0b1fceece808
	github.com/wundergraph/graphql-go-tools/v2 v2.0.0-rc.111
