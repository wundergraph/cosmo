...
require (
	...
	github.com/wundergraph/cosmo/demo v0.0.0-20240521153311-b82fb9731f28
	github.com/wundergraph/cosmo/router v0.0.0-20240518121137-086e1f07c044
	github.com/wundergraph/graphql-go-tools/v2 v2.0.0-rc.42
