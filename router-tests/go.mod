...
require (
	...
	github.com/wundergraph/cosmo/demo v0.0.0-20241007102459-be7c5a1a7154
	github.com/wundergraph/cosmo/router v0.0.0-20241007102459-be7c5a1a7154
	github.com/wundergraph/graphql-go-tools/v2 v2.0.0-rc.98
