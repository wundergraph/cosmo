...
require (
	...
	github.com/wundergraph/cosmo/router-wasm-module v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/wundergraph/cosmo/router-wasm-module => ../router-wasm-module
