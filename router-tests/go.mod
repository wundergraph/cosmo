...
require (
	...
	github.com/wundergraph/cosmo/demo v0.0.0-20240807132231-b9f2cd12cd2b
	github.com/wundergraph/cosmo/router v0.0.0-20240807132231-b9f2cd12cd2b
	github.com/wundergraph/graphql-go-tools/v2 v2.0.0-rc.70
