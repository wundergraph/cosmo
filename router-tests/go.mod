...
require (
	...
	github.com/wundergraph/cosmo/demo v0.0.0-20241107164154-1e6939d6be68
	github.com/wundergraph/cosmo/router v0.0.0-20241107164154-1e6939d6be68
	github.com/wundergraph/graphql-go-tools/v2 v2.0.0-rc.120
