import { Body, Button, Head, Heading, Html, Link, Preview, Section, Text, Row } from '@react-email/components';
      ...
      <TailwindConfig>
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          ...
          <MainContainer>
            ...
            <Text>
              This irreversible deletion will take place on <span className="font-bold">[%= deletionDate %]</span> and
              will permanently remove the organization and all data associated with it.
            </Text>
            <Text className="font-bold">If this was unintentional and you would like to cancel the deletion:</Text>
