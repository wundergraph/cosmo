import { Body, Button, Head, Heading, Html, Link, Preview, Section, Text } from '@react-email/components';
      ...
      <TailwindConfig>
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          ...
          <MainContainer>
            ...
            <Text className="text-black text-[14px] leading-[24px]">[%- inviteBody %]</Text>
