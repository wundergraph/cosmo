...
export function getFederatedGraphByName(opts: RouterOptions, req: GetFederatedGraphByNameRequest, ctx: HandlerContext): Promise<PlainMessage<GetFederatedGraphByNameResponse>> {
