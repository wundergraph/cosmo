...
export function getSubgraphCheckExtensionsConfig(
  ...
  ctx: HandlerContext,
): Promise<GetSubgraphCheckExtensionsConfigResponse> {
  let logger = getLogger(ctx, opts.logger);

  return handleError<GetSubgraphCheckExtensionsConfigResponse>(ctx, logger, async () => {
    ...
    return {
      ...
      isLintingEnabledForNamespace: namespace.enableLinting,
      isGraphPruningEnabledForNamespace: namespace.enableGraphPruning,
