CREATE TABLE IF NOT EXISTS "feature_flags_to_feature_subgraphs" (
	"feature_flag_id" uuid NOT NULL,
	"feature_subgraph_id" uuid NOT NULL,
	CONSTRAINT "feature_flags_to_feature_subgraphs_feature_flag_id_feature_subgraph_id_pk" PRIMARY KEY("feature_flag_id","feature_subgraph_id")
);
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "feature_subgraphs_to_base_subgraphs" (
	"feature_subgraph_id" uuid NOT NULL,
	"base_subgraph_id" uuid NOT NULL,
	CONSTRAINT "feature_subgraphs_to_base_subgraphs_feature_subgraph_id_base_subgraph_id_pk" PRIMARY KEY("feature_subgraph_id","base_subgraph_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "federated_graphs_to_feature_flag_schema_versions" (
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "feature_flags_to_feature_subgraphs" ADD CONSTRAINT "feature_flags_to_feature_subgraphs_feature_subgraph_id_subgraphs_id_fk" FOREIGN KEY ("feature_subgraph_id") REFERENCES "subgraphs"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "feature_subgraphs_to_base_subgraphs" ADD CONSTRAINT "feature_subgraphs_to_base_subgraphs_feature_subgraph_id_subgraphs_id_fk" FOREIGN KEY ("feature_subgraph_id") REFERENCES "subgraphs"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "feature_subgraphs_to_base_subgraphs" ADD CONSTRAINT "feature_subgraphs_to_base_subgraphs_base_subgraph_id_subgraphs_id_fk" FOREIGN KEY ("base_subgraph_id") REFERENCES "subgraphs"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "federated_graphs_to_feature_flag_schema_versions" ADD CONSTRAINT "federated_graphs_to_feature_flag_schema_versions_federated_graph_id_federated_graphs_id_fk" FOREIGN KEY ("federated_graph_id") REFERENCES "federated_graphs"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "federated_graphs_to_feature_flag_schema_versions" ADD CONSTRAINT "federated_graphs_to_feature_flag_schema_versions_base_composition_schema_version_id_schema_versions_id_fk" FOREIGN KEY ("base_composition_schema_version_id") REFERENCES "schema_versions"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
