...
CREATE INDEX IF NOT EXISTS "scpm_proposal_id_idx" ON "schema_check_proposal_match" USING btree ("proposal_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "scp_check_id_proposal_id_idx" ON "schema_check_proposals" USING btree ("schema_check_id","proposal_id");