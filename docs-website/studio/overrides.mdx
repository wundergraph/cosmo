---
title: "Overrides"
description: "Override the result of operation checks for breaking changes that affect individual operations which you deem are safe. Overrides are active across all graphs in a namespace."
icon: overline
---
