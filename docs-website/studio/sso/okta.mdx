...
<Step>
  Now you can assign users and groups to the application, and those users will be able to log into Cosmo using the URL provided when you set up the provider.
</Step>
</Steps>

<Info>
  Ensure that users added to the application have a username.
</Info>
