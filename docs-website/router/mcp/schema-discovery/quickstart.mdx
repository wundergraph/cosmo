...
This tutorial takes about 10 minutes. Follow every step in order. Each step shows what you must see before you continue.
...
```json
{
  "data": {
    "employees": [
      { "id": 1, "details": { "forename": "Jens", "surname": "Neuse" }, "currentMood": "HAPPY" }
    ]
  }
}
```
