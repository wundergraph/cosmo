...
- `continue`: ignore invalid credentials and proceed as unauthenticated. Required authentication and field authorization still apply.
...
The original credential remains available to custom modules and [configured header forwarding](/router/proxy-capabilities/subgraph-request-header-operations).
