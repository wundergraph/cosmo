...
Each feature flag has its own schema and plan cache. Operations in the manifest are validated per feature flag. An operation targeting one feature flag may be invalid on another. The router handles this gracefully.
