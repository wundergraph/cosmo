...
Connection and pool settings are passed in the URL query string, e.g. `redis://localhost:6379/?pool_size=20`. See [Redis Connection URLs](/router/configuration#redis-connection-urls).
