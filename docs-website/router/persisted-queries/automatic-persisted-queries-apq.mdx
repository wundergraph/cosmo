...
URLs can be supplied with redis configuration options embedded in the query string, including connection pool settings. See [Redis Connection URLs](/router/configuration#redis-connection-urls) for the full list.
</Info>
<Note>
