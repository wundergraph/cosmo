...
| STORAGE_PROVIDER_S3_{n}_SECURE    | secure     | <Icon icon="square" />                        | Whether to use HTTPS for S3 connections                     | true          |
...
| STORAGE_PROVIDER_CDN_{n}_URL   | url  | <Icon icon="square-check" iconType="solid" /> | The URL of the CDN                                          | https://cosmo-cdn.wundergraph.com |
