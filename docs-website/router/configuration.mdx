...
| ENGINE_ENABLE_DEFER                                           | enable_defer                                           | <Icon icon="square" /> | Enables [incremental delivery with `@defer`](/router/incremental-delivery), allowing clients to receive the initial response before deferred fields are streamed.                                                                                                                                                                            | false         |
