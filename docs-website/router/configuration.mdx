...
| PERSISTED_OPERATIONS_ALLOW_CUSTOM_IDS | persisted_operations.allow_custom_ids | <Icon icon="square" /> | Accept immutable custom IDs of 1–250 ASCII letters, digits, underscores, or hyphens. Requires APQ to be disabled. Supports per-operation and manifest lookup. | false |
