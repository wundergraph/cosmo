...
|                      | handlers.on_broadcast_events.handler_timeout       | <Icon icon="square" /> | The maximum time to wait for all OnBroadcastEvents handlers to complete per event-batch. | 5s          |
