...
| Environment Variable                                            | YAML                            | Required               | Description                                                                                                                                     | Default Value                                              |
|-----------------------------------------------------------------|---------------------------------|------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| ENGINE_VALIDATE_INLINE_ARGUMENTS_MODE                          | mode                            | <Icon icon="square" /> | `off` disables the feature; `enabled-non-enforcing` detects and records inline arguments while still executing; `enabled-enforcing` rejects operations that use inline argument values. | off                                                       |
