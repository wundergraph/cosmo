...
Variable expansion is supported for NATS subjects and Kafka topics. When using Kafka topic templates, make sure the rendered Kafka topics already exist. The Router does not create Kafka topics automatically.
