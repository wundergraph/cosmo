...
A client that asks for a different incremental delivery format, such as `multipart/mixed;deferSpec=20220824` sent by Apollo Router clients, would parse the response incorrectly and lose the deferred data.
