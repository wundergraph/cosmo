...
function batchNormalize({ subgraphs }: { subgraphs: Subgraph[]; version?: typeof ROUTER_COMPATIBILITY_VERSION_ONE }) {
  return new BatchNormalizer({ subgraphs }).batchNormalize();
}
