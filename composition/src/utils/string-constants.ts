...
export const HTTP_OPERATION = 'httpOperation';
...
export const IS_BINARY = 'isBinary';
...
export const OPERATION_HEADERS = 'operationHeaders';
export const OPERATION_SPECIFIC_HEADERS = 'operationSpecificHeaders';
...
export const QUERY_PARAM_ARG_MAP = 'queryParamArgMap';
export const QUERY_STRING_OPTIONS = 'queryStringOptions';
export const QUERY_STRING_OPTIONS_BY_PARAM = 'queryStringOptionsByParam';
export const QUERY_UPPER = 'QUERY';
export const QUOTATION_JOIN = `", "`;
export const REQUEST_BASE_BODY = 'requestBaseBody';
