...
export const CACHE_POPULATE = 'openfed__cachePopulate';
...
export const ENTITY_CACHE = 'openfed__entityCache';
...
export const LITERAL_OPEN_BRACE = '{';
...
export const QUERY_CACHE = 'openfed__queryCache';
