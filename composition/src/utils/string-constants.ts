...
export const NON_NULLABLE_PUBLISH_EVENT_RESULT = 'PublishEventResult!';
...
export const PUBLISH_EVENT_RESULT = 'PublishEventResult';
...
export const EVENT_DIRECTIVE_NAMES = new Set<string>([EVENTS_PUBLISH, EVENTS_REQUEST, EVENTS_SUBSCRIBE]);
