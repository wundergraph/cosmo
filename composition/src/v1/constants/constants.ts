...
>([
  ...
  [OPENFED_ENTITY_CACHE, OPENFED_ENTITY_CACHE_DEFINITION],
  [OPENFED_CACHE_INVALIDATE, OPENFED_CACHE_INVALIDATE_DEFINITION],
  ...
  [FROM_CONTEXT, FROM_CONTEXT_DEFINITION],
...
export const BASE_SCALARS: ReadonlySet<TypeName> = new Set<TypeName>([
  '_Any',
  '_Entities',
  BOOLEAN_SCALAR,
  CONTEXT_FIELD_VALUE,
