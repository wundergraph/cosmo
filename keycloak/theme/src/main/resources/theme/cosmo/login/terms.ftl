...
<@layoutCloudIAM.registrationCloudIamLayout displayMessage=false; section>
    ...
    <#elseif section = "form">
        <div id="kc-terms-text">
            <p>
                Thank you for your interest in WunderGraph Cosmo! We're happy you're here.<br/><br/>In order to sign up for Cosmo, please read and accept the <a href="https://wundergraph.com/cosmo-managed-service-terms" target="_blank">Cosmo Managed Service Terms of Use</a> and the <a href="https://wundergraph.com/privacy-policy" target="_blank">Privacy Policy</a>.
            </p>
        </div>
