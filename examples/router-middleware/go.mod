...
require github.com/wundergraph/cosmo/router v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/wundergraph/graphql-go-tools/v2 v2.0.0-rc.2.0.20230829102818-e2553cf069d3 // indirect
