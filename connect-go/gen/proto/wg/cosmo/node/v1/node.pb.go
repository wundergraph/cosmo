...
func (x *EntityCaching) GetCacheInvalidateConfigurations() []*CacheInvalidateConfiguration {
	if x != nil {
...
func (x *EntityCaching) GetQueryCacheConfigurations() []*QueryCacheConfiguration {
	if x != nil {
...
var file_wg_cosmo_node_v1_node_proto_depIdxs = []int32{
	...
	25,  // 32: wg.cosmo.node.v1.EntityCaching.query_cache_configurations:type_name -> wg.cosmo.node.v1.QueryCacheConfiguration
