...
const (
	SatisfiedOperationType_QUERY        SatisfiedOperationType = 0
	SatisfiedOperationType_MUTATION     SatisfiedOperationType = 1
	SatisfiedOperationType_SUBSCRIPTION SatisfiedOperationType = 2
)
...
func (HTTPMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_wg_cosmo_node_v1_node_proto_enumTypes[8].Descriptor()
}

func (HTTPMethod) Type() protoreflect.EnumType {
	return &file_wg_cosmo_node_v1_node_proto_enumTypes[8]
}
...
type SatisfiedQuery struct {
	...
	OperationType   SatisfiedOperationType `protobuf:"varint,4,opt,name=operation_type,json=operationType,proto3,enum=wg.cosmo.node.v1.SatisfiedOperationType" json:"operation_type,omitempty"`
...
func (x *SatisfiedQuery) GetOperationType() SatisfiedOperationType {
	...
	return SatisfiedOperationType_QUERY
}
...
type EngineConfiguration struct {
	...
	// Content hash of graphqlSchema, formatted as "sha256:<lowercase hex>".
	SchemaHash    string `protobuf:"bytes,8,opt,name=schema_hash,json=schemaHash,proto3" json:"schema_hash,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EngineConfiguration) GetSchemaHash() string {
	if x != nil {
		return x.SchemaHash
	}
	return ""
...
func (x *EntityCachingConfiguration) GetCacheInvalidateConfigurations() []*CacheInvalidateConfiguration {
	if x != nil {
...
func (x *EntityCachingConfiguration) GetCachePopulateConfigurations() []*CachePopulateConfiguration {
	if x != nil {
...
type FieldWeightConfiguration struct {
	...
	DirectiveArgumentWeights map[string]int32       `protobuf:"bytes,5,rep,name=directive_argument_weights,json=directiveArgumentWeights,proto3" json:"directive_argument_weights,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
const file_wg_cosmo_node_v1_node_proto_rawDesc = "" +
	...
	"\x05query\x18\x02 \x01(\v2 .wg.cosmo.node.v1.SatisfiedQueryH\x00R\x05query\x88\x01\x01B\b\n" +
	"\x06_query\"\xf1\x01\n" +
	"\x0eSatisfiedQuery\x12 \n" +
	"\vdescription\x18\x01 \x01(\tR\vdescription\x12\x1a\n" +
	"\bdocument\x18\x02 \x01(\tR\bdocument\x12%\n" +
	"\x0eoperation_name\x18\x03 \x01(\tR\roperationName\x12O\n" +
	"\x0eoperation_type\x18\x04 \x01(\x0e2(.wg.cosmo.node.v1.SatisfiedOperationTypeR\roperationType\x12)\n" +
	"\x10variables_schema\x18\x05 \x01(\tR\x0fvariablesSchema\"\x9d\x05\n" +
	...
	"\x15graphql_client_schema\x18\a \x01(\tH\x00R\x13graphqlClientSchema\x88\x01\x01\x12\x1f\n" +
	"\vschema_hash\x18\b \x01(\tR\n" +
	"schemaHash\x1a@\n" +
	...
	"\x1centity_caching_configuration\x18\x11 \x01(\v2,.wg.cosmo.node.v1.EntityCachingConfigurationR\x1aentityCachingConfiguration\"\xf2\x02\n" +
	...
	"\aOPTIONS\x10\x042\xd2\x01\n" +
	"\vNodeService\x12_\n" +
	"\fSelfRegister\x12%.wg.cosmo.node.v1.SelfRegisterRequest\x1a&.wg.cosmo.node.v1.SelfRegisterResponse\"\x00\x12b\n" +
	"\rGenerateQuery\x12&.wg.cosmo.node.v1.GenerateQueryRequest\x1a'.wg.cosmo.node.v1.GenerateQueryResponse\"\x00B\xcf\x01\n" +
...
var file_wg_cosmo_node_v1_node_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_wg_cosmo_node_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 81)
var file_wg_cosmo_node_v1_node_proto_goTypes = []any{
	(SatisfiedOperationType)(0),               // 0: wg.cosmo.node.v1.SatisfiedOperationType
	(ArgumentRenderConfiguration)(0),          // 1: wg.cosmo.node.v1.ArgumentRenderConfiguration
	(ArgumentSource)(0),                       // 2: wg.cosmo.node.v1.ArgumentSource
	(DataSourceKind)(0),                       // 3: wg.cosmo.node.v1.DataSourceKind
	(LookupType)(0),                           // 4: wg.cosmo.node.v1.LookupType
	(OperationType)(0),                        // 5: wg.cosmo.node.v1.OperationType
	(EventType)(0),                            // 6: wg.cosmo.node.v1.EventType
	(ConfigurationVariableKind)(0),            // 7: wg.cosmo.node.v1.ConfigurationVariableKind
	(HTTPMethod)(0),                           // 8: wg.cosmo.node.v1.HTTPMethod
	(*Subgraph)(nil),                          // 9: wg.cosmo.node.v1.Subgraph
	(*FeatureFlagRouterExecutionConfigs)(nil), // 10: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs
	(*FeatureFlagRouterExecutionConfig)(nil),  // 11: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfig
	(*RouterConfig)(nil),                      // 12: wg.cosmo.node.v1.RouterConfig
	(*Response)(nil),                          // 13: wg.cosmo.node.v1.Response
	(*ResponseStatus)(nil),                    // 14: wg.cosmo.node.v1.ResponseStatus
	(*RegistrationInfo)(nil),                  // 15: wg.cosmo.node.v1.RegistrationInfo
	(*AccountLimits)(nil),                     // 16: wg.cosmo.node.v1.AccountLimits
	(*SelfRegisterRequest)(nil),               // 17: wg.cosmo.node.v1.SelfRegisterRequest
	(*SelfRegisterResponse)(nil),              // 18: wg.cosmo.node.v1.SelfRegisterResponse
	(*GenerateQueryRequest)(nil),              // 19: wg.cosmo.node.v1.GenerateQueryRequest
	(*GenerateQueryResponse)(nil),             // 20: wg.cosmo.node.v1.GenerateQueryResponse
	(*SatisfiedQuery)(nil),                    // 21: wg.cosmo.node.v1.SatisfiedQuery
	(*EngineConfiguration)(nil),               // 22: wg.cosmo.node.v1.EngineConfiguration
	(*DataSourceConfiguration)(nil),           // 23: wg.cosmo.node.v1.DataSourceConfiguration
	(*EntityCachingConfiguration)(nil),        // 24: wg.cosmo.node.v1.EntityCachingConfiguration
	(*EntityCacheConfiguration)(nil),          // 25: wg.cosmo.node.v1.EntityCacheConfiguration
	(*CacheInvalidateConfiguration)(nil),      // 26: wg.cosmo.node.v1.CacheInvalidateConfiguration
	(*CachePopulateConfiguration)(nil),        // 27: wg.cosmo.node.v1.CachePopulateConfiguration
	(*CostConfiguration)(nil),                 // 28: wg.cosmo.node.v1.CostConfiguration
	(*FieldWeightConfiguration)(nil),          // 29: wg.cosmo.node.v1.FieldWeightConfiguration
	(*FieldListSizeConfiguration)(nil),        // 30: wg.cosmo.node.v1.FieldListSizeConfiguration
	(*ArgumentConfiguration)(nil),             // 31: wg.cosmo.node.v1.ArgumentConfiguration
	(*Scopes)(nil),                            // 32: wg.cosmo.node.v1.Scopes
	(*AuthorizationConfiguration)(nil),        // 33: wg.cosmo.node.v1.AuthorizationConfiguration
	(*FieldConfiguration)(nil),                // 34: wg.cosmo.node.v1.FieldConfiguration
	(*TypeConfiguration)(nil),                 // 35: wg.cosmo.node.v1.TypeConfiguration
	(*TypeField)(nil),                         // 36: wg.cosmo.node.v1.TypeField
	(*FieldCoordinates)(nil),                  // 37: wg.cosmo.node.v1.FieldCoordinates
	(*FieldSetCondition)(nil),                 // 38: wg.cosmo.node.v1.FieldSetCondition
	(*RequiredField)(nil),                     // 39: wg.cosmo.node.v1.RequiredField
	(*EntityInterfaceConfiguration)(nil),      // 40: wg.cosmo.node.v1.EntityInterfaceConfiguration
	(*FetchConfiguration)(nil),                // 41: wg.cosmo.node.v1.FetchConfiguration
	(*StatusCodeTypeMapping)(nil),             // 42: wg.cosmo.node.v1.StatusCodeTypeMapping
	(*DataSourceCustom_GraphQL)(nil),          // 43: wg.cosmo.node.v1.DataSourceCustom_GraphQL
	(*GRPCConfiguration)(nil),                 // 44: wg.cosmo.node.v1.GRPCConfiguration
	(*ImageReference)(nil),                    // 45: wg.cosmo.node.v1.ImageReference
	(*PluginConfiguration)(nil),               // 46: wg.cosmo.node.v1.PluginConfiguration
	(*SSLConfiguration)(nil),                  // 47: wg.cosmo.node.v1.SSLConfiguration
	(*GRPCMapping)(nil),                       // 48: wg.cosmo.node.v1.GRPCMapping
	(*LookupMapping)(nil),                     // 49: wg.cosmo.node.v1.LookupMapping
	(*LookupFieldMapping)(nil),                // 50: wg.cosmo.node.v1.LookupFieldMapping
	(*OperationMapping)(nil),                  // 51: wg.cosmo.node.v1.OperationMapping
	(*EntityMapping)(nil),                     // 52: wg.cosmo.node.v1.EntityMapping
	(*RequiredFieldMapping)(nil),              // 53: wg.cosmo.node.v1.RequiredFieldMapping
	(*TypeFieldMapping)(nil),                  // 54: wg.cosmo.node.v1.TypeFieldMapping
	(*FieldMapping)(nil),                      // 55: wg.cosmo.node.v1.FieldMapping
	(*ArgumentMapping)(nil),                   // 56: wg.cosmo.node.v1.ArgumentMapping
	(*EnumMapping)(nil),                       // 57: wg.cosmo.node.v1.EnumMapping
	(*EnumValueMapping)(nil),                  // 58: wg.cosmo.node.v1.EnumValueMapping
	(*NatsStreamConfiguration)(nil),           // 59: wg.cosmo.node.v1.NatsStreamConfiguration
	(*NatsEventConfiguration)(nil),            // 60: wg.cosmo.node.v1.NatsEventConfiguration
	(*KafkaEventConfiguration)(nil),           // 61: wg.cosmo.node.v1.KafkaEventConfiguration
	(*RedisEventConfiguration)(nil),           // 62: wg.cosmo.node.v1.RedisEventConfiguration
	(*EngineEventConfiguration)(nil),          // 63: wg.cosmo.node.v1.EngineEventConfiguration
	(*DataSourceCustomEvents)(nil),            // 64: wg.cosmo.node.v1.DataSourceCustomEvents
	(*DataSourceCustom_Static)(nil),           // 65: wg.cosmo.node.v1.DataSourceCustom_Static
	(*ConfigurationVariable)(nil),             // 66: wg.cosmo.node.v1.ConfigurationVariable
	(*DirectiveConfiguration)(nil),            // 67: wg.cosmo.node.v1.DirectiveConfiguration
	(*URLQueryConfiguration)(nil),             // 68: wg.cosmo.node.v1.URLQueryConfiguration
	(*HTTPHeader)(nil),                        // 69: wg.cosmo.node.v1.HTTPHeader
	(*MTLSConfiguration)(nil),                 // 70: wg.cosmo.node.v1.MTLSConfiguration
	(*GraphQLSubscriptionConfiguration)(nil),  // 71: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration
	(*GraphQLFederationConfiguration)(nil),    // 72: wg.cosmo.node.v1.GraphQLFederationConfiguration
	(*InternedString)(nil),                    // 73: wg.cosmo.node.v1.InternedString
	(*SingleTypeField)(nil),                   // 74: wg.cosmo.node.v1.SingleTypeField
	(*SubscriptionFieldCondition)(nil),        // 75: wg.cosmo.node.v1.SubscriptionFieldCondition
	(*SubscriptionFilterCondition)(nil),       // 76: wg.cosmo.node.v1.SubscriptionFilterCondition
	(*CacheWarmerOperations)(nil),             // 77: wg.cosmo.node.v1.CacheWarmerOperations
	(*Operation)(nil),                         // 78: wg.cosmo.node.v1.Operation
	(*OperationRequest)(nil),                  // 79: wg.cosmo.node.v1.OperationRequest
	(*Extension)(nil),                         // 80: wg.cosmo.node.v1.Extension
	(*PersistedQuery)(nil),                    // 81: wg.cosmo.node.v1.PersistedQuery
	(*ClientInfo)(nil),                        // 82: wg.cosmo.node.v1.ClientInfo
	nil,                                       // 83: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry
	nil,                                       // 84: wg.cosmo.node.v1.EngineConfiguration.StringStorageEntry
	nil,                                       // 85: wg.cosmo.node.v1.CostConfiguration.TypeWeightsEntry
	nil,                                       // 86: wg.cosmo.node.v1.CostConfiguration.DirectiveArgumentWeightsEntry
	nil,                                       // 87: wg.cosmo.node.v1.FieldWeightConfiguration.ArgumentWeightsEntry
	nil,                                       // 88: wg.cosmo.node.v1.FieldWeightConfiguration.DirectiveArgumentWeightsEntry
	nil,                                       // 89: wg.cosmo.node.v1.FetchConfiguration.HeaderEntry
	(common.EnumStatusCode)(0),                // 90: wg.cosmo.common.EnumStatusCode
	(common.GraphQLSubscriptionProtocol)(0),   // 91: wg.cosmo.common.GraphQLSubscriptionProtocol
	(common.GraphQLWebsocketSubprotocol)(0),   // 92: wg.cosmo.common.GraphQLWebsocketSubprotocol
}
var file_wg_cosmo_node_v1_node_proto_depIdxs = []int32{
	83,  // 0: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.config_by_feature_flag_name:type_name -> wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry
	22,  // 1: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfig.engine_config:type_name -> wg.cosmo.node.v1.EngineConfiguration
	9,   // 2: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfig.subgraphs:type_name -> wg.cosmo.node.v1.Subgraph
	22,  // 3: wg.cosmo.node.v1.RouterConfig.engine_config:type_name -> wg.cosmo.node.v1.EngineConfiguration
	9,   // 4: wg.cosmo.node.v1.RouterConfig.subgraphs:type_name -> wg.cosmo.node.v1.Subgraph
	10,  // 5: wg.cosmo.node.v1.RouterConfig.feature_flag_configs:type_name -> wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs
	90,  // 6: wg.cosmo.node.v1.Response.code:type_name -> wg.cosmo.common.EnumStatusCode
	16,  // 7: wg.cosmo.node.v1.RegistrationInfo.account_limits:type_name -> wg.cosmo.node.v1.AccountLimits
	13,  // 8: wg.cosmo.node.v1.SelfRegisterResponse.response:type_name -> wg.cosmo.node.v1.Response
	15,  // 9: wg.cosmo.node.v1.SelfRegisterResponse.registrationInfo:type_name -> wg.cosmo.node.v1.RegistrationInfo
	13,  // 10: wg.cosmo.node.v1.GenerateQueryResponse.response:type_name -> wg.cosmo.node.v1.Response
	21,  // 11: wg.cosmo.node.v1.GenerateQueryResponse.query:type_name -> wg.cosmo.node.v1.SatisfiedQuery
	0,   // 12: wg.cosmo.node.v1.SatisfiedQuery.operation_type:type_name -> wg.cosmo.node.v1.SatisfiedOperationType
	23,  // 13: wg.cosmo.node.v1.EngineConfiguration.datasource_configurations:type_name -> wg.cosmo.node.v1.DataSourceConfiguration
	34,  // 14: wg.cosmo.node.v1.EngineConfiguration.field_configurations:type_name -> wg.cosmo.node.v1.FieldConfiguration
	35,  // 15: wg.cosmo.node.v1.EngineConfiguration.type_configurations:type_name -> wg.cosmo.node.v1.TypeConfiguration
	84,  // 16: wg.cosmo.node.v1.EngineConfiguration.string_storage:type_name -> wg.cosmo.node.v1.EngineConfiguration.StringStorageEntry
	3,   // 17: wg.cosmo.node.v1.DataSourceConfiguration.kind:type_name -> wg.cosmo.node.v1.DataSourceKind
	36,  // 18: wg.cosmo.node.v1.DataSourceConfiguration.root_nodes:type_name -> wg.cosmo.node.v1.TypeField
	36,  // 19: wg.cosmo.node.v1.DataSourceConfiguration.child_nodes:type_name -> wg.cosmo.node.v1.TypeField
	43,  // 20: wg.cosmo.node.v1.DataSourceConfiguration.custom_graphql:type_name -> wg.cosmo.node.v1.DataSourceCustom_GraphQL
	65,  // 21: wg.cosmo.node.v1.DataSourceConfiguration.custom_static:type_name -> wg.cosmo.node.v1.DataSourceCustom_Static
	67,  // 22: wg.cosmo.node.v1.DataSourceConfiguration.directives:type_name -> wg.cosmo.node.v1.DirectiveConfiguration
	39,  // 23: wg.cosmo.node.v1.DataSourceConfiguration.keys:type_name -> wg.cosmo.node.v1.RequiredField
	39,  // 24: wg.cosmo.node.v1.DataSourceConfiguration.provides:type_name -> wg.cosmo.node.v1.RequiredField
	39,  // 25: wg.cosmo.node.v1.DataSourceConfiguration.requires:type_name -> wg.cosmo.node.v1.RequiredField
	64,  // 26: wg.cosmo.node.v1.DataSourceConfiguration.custom_events:type_name -> wg.cosmo.node.v1.DataSourceCustomEvents
	40,  // 27: wg.cosmo.node.v1.DataSourceConfiguration.entity_interfaces:type_name -> wg.cosmo.node.v1.EntityInterfaceConfiguration
	40,  // 28: wg.cosmo.node.v1.DataSourceConfiguration.interface_objects:type_name -> wg.cosmo.node.v1.EntityInterfaceConfiguration
	28,  // 29: wg.cosmo.node.v1.DataSourceConfiguration.cost_configuration:type_name -> wg.cosmo.node.v1.CostConfiguration
	24,  // 30: wg.cosmo.node.v1.DataSourceConfiguration.entity_caching_configuration:type_name -> wg.cosmo.node.v1.EntityCachingConfiguration
	25,  // 31: wg.cosmo.node.v1.EntityCachingConfiguration.entity_cache_configurations:type_name -> wg.cosmo.node.v1.EntityCacheConfiguration
	26,  // 32: wg.cosmo.node.v1.EntityCachingConfiguration.cache_invalidate_configurations:type_name -> wg.cosmo.node.v1.CacheInvalidateConfiguration
	27,  // 33: wg.cosmo.node.v1.EntityCachingConfiguration.cache_populate_configurations:type_name -> wg.cosmo.node.v1.CachePopulateConfiguration
	29,  // 34: wg.cosmo.node.v1.CostConfiguration.field_weights:type_name -> wg.cosmo.node.v1.FieldWeightConfiguration
	30,  // 35: wg.cosmo.node.v1.CostConfiguration.list_sizes:type_name -> wg.cosmo.node.v1.FieldListSizeConfiguration
	85,  // 36: wg.cosmo.node.v1.CostConfiguration.type_weights:type_name -> wg.cosmo.node.v1.CostConfiguration.TypeWeightsEntry
	86,  // 37: wg.cosmo.node.v1.CostConfiguration.directive_argument_weights:type_name -> wg.cosmo.node.v1.CostConfiguration.DirectiveArgumentWeightsEntry
	87,  // 38: wg.cosmo.node.v1.FieldWeightConfiguration.argument_weights:type_name -> wg.cosmo.node.v1.FieldWeightConfiguration.ArgumentWeightsEntry
	88,  // 39: wg.cosmo.node.v1.FieldWeightConfiguration.directive_argument_weights:type_name -> wg.cosmo.node.v1.FieldWeightConfiguration.DirectiveArgumentWeightsEntry
	2,   // 40: wg.cosmo.node.v1.ArgumentConfiguration.source_type:type_name -> wg.cosmo.node.v1.ArgumentSource
	32,  // 41: wg.cosmo.node.v1.AuthorizationConfiguration.required_or_scopes:type_name -> wg.cosmo.node.v1.Scopes
	32,  // 42: wg.cosmo.node.v1.AuthorizationConfiguration.required_or_scopes_by_or:type_name -> wg.cosmo.node.v1.Scopes
	31,  // 43: wg.cosmo.node.v1.FieldConfiguration.arguments_configuration:type_name -> wg.cosmo.node.v1.ArgumentConfiguration
	33,  // 44: wg.cosmo.node.v1.FieldConfiguration.authorization_configuration:type_name -> wg.cosmo.node.v1.AuthorizationConfiguration
	76,  // 45: wg.cosmo.node.v1.FieldConfiguration.subscription_filter_condition:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	37,  // 46: wg.cosmo.node.v1.FieldSetCondition.field_coordinates_path:type_name -> wg.cosmo.node.v1.FieldCoordinates
	38,  // 47: wg.cosmo.node.v1.RequiredField.conditions:type_name -> wg.cosmo.node.v1.FieldSetCondition
	66,  // 48: wg.cosmo.node.v1.FetchConfiguration.url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	8,   // 49: wg.cosmo.node.v1.FetchConfiguration.method:type_name -> wg.cosmo.node.v1.HTTPMethod
	89,  // 50: wg.cosmo.node.v1.FetchConfiguration.header:type_name -> wg.cosmo.node.v1.FetchConfiguration.HeaderEntry
	66,  // 51: wg.cosmo.node.v1.FetchConfiguration.body:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	68,  // 52: wg.cosmo.node.v1.FetchConfiguration.query:type_name -> wg.cosmo.node.v1.URLQueryConfiguration
	70,  // 53: wg.cosmo.node.v1.FetchConfiguration.mtls:type_name -> wg.cosmo.node.v1.MTLSConfiguration
	66,  // 54: wg.cosmo.node.v1.FetchConfiguration.base_url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	66,  // 55: wg.cosmo.node.v1.FetchConfiguration.path:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	66,  // 56: wg.cosmo.node.v1.FetchConfiguration.http_proxy_url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	41,  // 57: wg.cosmo.node.v1.DataSourceCustom_GraphQL.fetch:type_name -> wg.cosmo.node.v1.FetchConfiguration
	71,  // 58: wg.cosmo.node.v1.DataSourceCustom_GraphQL.subscription:type_name -> wg.cosmo.node.v1.GraphQLSubscriptionConfiguration
	72,  // 59: wg.cosmo.node.v1.DataSourceCustom_GraphQL.federation:type_name -> wg.cosmo.node.v1.GraphQLFederationConfiguration
	73,  // 60: wg.cosmo.node.v1.DataSourceCustom_GraphQL.upstream_schema:type_name -> wg.cosmo.node.v1.InternedString
	74,  // 61: wg.cosmo.node.v1.DataSourceCustom_GraphQL.custom_scalar_type_fields:type_name -> wg.cosmo.node.v1.SingleTypeField
	44,  // 62: wg.cosmo.node.v1.DataSourceCustom_GraphQL.grpc:type_name -> wg.cosmo.node.v1.GRPCConfiguration
	48,  // 63: wg.cosmo.node.v1.GRPCConfiguration.mapping:type_name -> wg.cosmo.node.v1.GRPCMapping
	46,  // 64: wg.cosmo.node.v1.GRPCConfiguration.plugin:type_name -> wg.cosmo.node.v1.PluginConfiguration
	45,  // 65: wg.cosmo.node.v1.PluginConfiguration.image_reference:type_name -> wg.cosmo.node.v1.ImageReference
	51,  // 66: wg.cosmo.node.v1.GRPCMapping.operation_mappings:type_name -> wg.cosmo.node.v1.OperationMapping
	52,  // 67: wg.cosmo.node.v1.GRPCMapping.entity_mappings:type_name -> wg.cosmo.node.v1.EntityMapping
	54,  // 68: wg.cosmo.node.v1.GRPCMapping.type_field_mappings:type_name -> wg.cosmo.node.v1.TypeFieldMapping
	57,  // 69: wg.cosmo.node.v1.GRPCMapping.enum_mappings:type_name -> wg.cosmo.node.v1.EnumMapping
	49,  // 70: wg.cosmo.node.v1.GRPCMapping.resolve_mappings:type_name -> wg.cosmo.node.v1.LookupMapping
	4,   // 71: wg.cosmo.node.v1.LookupMapping.type:type_name -> wg.cosmo.node.v1.LookupType
	50,  // 72: wg.cosmo.node.v1.LookupMapping.lookup_mapping:type_name -> wg.cosmo.node.v1.LookupFieldMapping
	55,  // 73: wg.cosmo.node.v1.LookupFieldMapping.field_mapping:type_name -> wg.cosmo.node.v1.FieldMapping
	5,   // 74: wg.cosmo.node.v1.OperationMapping.type:type_name -> wg.cosmo.node.v1.OperationType
	53,  // 75: wg.cosmo.node.v1.EntityMapping.required_field_mappings:type_name -> wg.cosmo.node.v1.RequiredFieldMapping
	55,  // 76: wg.cosmo.node.v1.RequiredFieldMapping.field_mapping:type_name -> wg.cosmo.node.v1.FieldMapping
	55,  // 77: wg.cosmo.node.v1.TypeFieldMapping.field_mappings:type_name -> wg.cosmo.node.v1.FieldMapping
	56,  // 78: wg.cosmo.node.v1.FieldMapping.argument_mappings:type_name -> wg.cosmo.node.v1.ArgumentMapping
	58,  // 79: wg.cosmo.node.v1.EnumMapping.values:type_name -> wg.cosmo.node.v1.EnumValueMapping
	63,  // 80: wg.cosmo.node.v1.NatsEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	59,  // 81: wg.cosmo.node.v1.NatsEventConfiguration.stream_configuration:type_name -> wg.cosmo.node.v1.NatsStreamConfiguration
	63,  // 82: wg.cosmo.node.v1.KafkaEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	63,  // 83: wg.cosmo.node.v1.RedisEventConfiguration.engine_event_configuration:type_name -> wg.cosmo.node.v1.EngineEventConfiguration
	6,   // 84: wg.cosmo.node.v1.EngineEventConfiguration.type:type_name -> wg.cosmo.node.v1.EventType
	60,  // 85: wg.cosmo.node.v1.DataSourceCustomEvents.nats:type_name -> wg.cosmo.node.v1.NatsEventConfiguration
	61,  // 86: wg.cosmo.node.v1.DataSourceCustomEvents.kafka:type_name -> wg.cosmo.node.v1.KafkaEventConfiguration
	62,  // 87: wg.cosmo.node.v1.DataSourceCustomEvents.redis:type_name -> wg.cosmo.node.v1.RedisEventConfiguration
	66,  // 88: wg.cosmo.node.v1.DataSourceCustom_Static.data:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	7,   // 89: wg.cosmo.node.v1.ConfigurationVariable.kind:type_name -> wg.cosmo.node.v1.ConfigurationVariableKind
	66,  // 90: wg.cosmo.node.v1.HTTPHeader.values:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	66,  // 91: wg.cosmo.node.v1.MTLSConfiguration.key:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	66,  // 92: wg.cosmo.node.v1.MTLSConfiguration.cert:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	66,  // 93: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.url:type_name -> wg.cosmo.node.v1.ConfigurationVariable
	91,  // 94: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.protocol:type_name -> wg.cosmo.common.GraphQLSubscriptionProtocol
	92,  // 95: wg.cosmo.node.v1.GraphQLSubscriptionConfiguration.websocketSubprotocol:type_name -> wg.cosmo.common.GraphQLWebsocketSubprotocol
	76,  // 96: wg.cosmo.node.v1.SubscriptionFilterCondition.and:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	75,  // 97: wg.cosmo.node.v1.SubscriptionFilterCondition.in:type_name -> wg.cosmo.node.v1.SubscriptionFieldCondition
	76,  // 98: wg.cosmo.node.v1.SubscriptionFilterCondition.not:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	76,  // 99: wg.cosmo.node.v1.SubscriptionFilterCondition.or:type_name -> wg.cosmo.node.v1.SubscriptionFilterCondition
	78,  // 100: wg.cosmo.node.v1.CacheWarmerOperations.operations:type_name -> wg.cosmo.node.v1.Operation
	79,  // 101: wg.cosmo.node.v1.Operation.request:type_name -> wg.cosmo.node.v1.OperationRequest
	82,  // 102: wg.cosmo.node.v1.Operation.client:type_name -> wg.cosmo.node.v1.ClientInfo
	80,  // 103: wg.cosmo.node.v1.OperationRequest.extensions:type_name -> wg.cosmo.node.v1.Extension
	81,  // 104: wg.cosmo.node.v1.Extension.persisted_query:type_name -> wg.cosmo.node.v1.PersistedQuery
	11,  // 105: wg.cosmo.node.v1.FeatureFlagRouterExecutionConfigs.ConfigByFeatureFlagNameEntry.value:type_name -> wg.cosmo.node.v1.FeatureFlagRouterExecutionConfig
	69,  // 106: wg.cosmo.node.v1.FetchConfiguration.HeaderEntry.value:type_name -> wg.cosmo.node.v1.HTTPHeader
	17,  // 107: wg.cosmo.node.v1.NodeService.SelfRegister:input_type -> wg.cosmo.node.v1.SelfRegisterRequest
	19,  // 108: wg.cosmo.node.v1.NodeService.GenerateQuery:input_type -> wg.cosmo.node.v1.GenerateQueryRequest
	18,  // 109: wg.cosmo.node.v1.NodeService.SelfRegister:output_type -> wg.cosmo.node.v1.SelfRegisterResponse
	20,  // 110: wg.cosmo.node.v1.NodeService.GenerateQuery:output_type -> wg.cosmo.node.v1.GenerateQueryResponse
