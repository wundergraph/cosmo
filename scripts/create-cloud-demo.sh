...
wgc subgraph create availability --namespace default --label team=A --routing-url https://availability-api.fly.dev/
wgc subgraph create mood --namespace default --label team=B --routing-url https://mood-api.fly.dev/
