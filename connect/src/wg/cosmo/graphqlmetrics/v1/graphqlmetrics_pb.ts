...
export class ArgumentUsageInfo extends Message<ArgumentUsageInfo> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "SubgraphIDs", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 6, name: "IsNull", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
...
export class InputUsageInfo extends Message<InputUsageInfo> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "SubgraphIDs", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 7, name: "IsNull", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
