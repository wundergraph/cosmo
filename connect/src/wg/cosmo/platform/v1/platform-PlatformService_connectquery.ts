 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.CreateOrganizationRuleSet
 */
export const createOrganizationRuleSet = {
  localName: "createOrganizationRuleSet",
  name: "CreateOrganizationRuleSet",
  kind: MethodKind.Unary,
  I: CreateOrganizationRuleSetRequest,
  O: CreateOrganizationRuleSetResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOrganizationRuleSets
 */
export const getOrganizationRuleSets = {
  localName: "getOrganizationRuleSets",
  name: "GetOrganizationRuleSets",
  kind: MethodKind.Unary,
  I: GetOrganizationRuleSetsRequest,
  O: GetOrganizationRuleSetsResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.UpdateOrganizationRuleSet
 */
export const updateOrganizationRuleSet = {
  localName: "updateOrganizationRuleSet",
  name: "UpdateOrganizationRuleSet",
  kind: MethodKind.Unary,
  I: UpdateOrganizationRuleSetRequest,
  O: UpdateOrganizationRuleSetResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.DeleteOrganizationRuleSet
 */
export const deleteOrganizationRuleSet = {
  localName: "deleteOrganizationRuleSet",
  name: "DeleteOrganizationRuleSet",
  kind: MethodKind.Unary,
  I: DeleteOrganizationRuleSetRequest,
  O: DeleteOrganizationRuleSetResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
