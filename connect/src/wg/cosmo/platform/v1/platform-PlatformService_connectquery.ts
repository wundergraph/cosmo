 ...
 */
export const completeOnboardingStep1 = {
  localName: "completeOnboardingStep1",
 ...
 */
export const completeOnboardingStep2 = {
  localName: "completeOnboardingStep2",
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.RestartOnboarding
 */
export const restartOnboarding = {
  localName: "restartOnboarding",
  name: "RestartOnboarding",
  kind: MethodKind.Unary,
  I: RestartOnboardingRequest,
  O: RestartOnboardingResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
