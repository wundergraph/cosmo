 ...
 */
export const createOIDCProvider = createQueryService({
  service: {
    methods: {
      createOIDCProvider: {
 ...
 */
export const getOIDCProvider = createQueryService({
  service: {
    methods: {
      getOIDCProvider: {
 ...
 */
export const deleteOIDCProvider = createQueryService({
  service: {
    methods: {
      deleteOIDCProvider: {
