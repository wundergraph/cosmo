 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.CheckOrganizationPermissions
 */
export const checkOrganizationPermissions = {
  localName: "checkOrganizationPermissions",
  name: "CheckOrganizationPermissions",
  kind: MethodKind.Unary,
  I: CheckOrganizationPermissionsRequest,
  O: CheckOrganizationPermissionsResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
