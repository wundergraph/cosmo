...
/**
 * EnableFeatureFlag enables/disables a feature flags
 *
...
/**
 * CreateFeatureFlagGroup creates a new group for the selected feature flags
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.CreateFeatureFlagGroup
 */
export const createFeatureFlagGroup = {
  localName: "createFeatureFlagGroup",
  name: "CreateFeatureFlagGroup",
  kind: MethodKind.Unary,
  I: CreateFeatureFlagGroupRequest,
  O: CreateFeatureFlagGroupResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
...
/**
 * UpdateFeatureFlagGroup updates a new group for the selected feature flags
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.UpdateFeatureFlagGroup
 */
export const updateFeatureFlagGroup = {
  localName: "updateFeatureFlagGroup",
  name: "UpdateFeatureFlagGroup",
  kind: MethodKind.Unary,
  I: UpdateFeatureFlagGroupRequest,
  O: UpdateFeatureFlagGroupResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
...
/**
 * EnableFeatureFlagGroup enables/disables a feature flag group
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.EnableFeatureFlagGroup
 */
export const enableFeatureFlagGroup = {
  localName: "enableFeatureFlagGroup",
  name: "EnableFeatureFlagGroup",
  kind: MethodKind.Unary,
  I: EnableFeatureFlagGroupRequest,
  O: EnableFeatureFlagGroupResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
