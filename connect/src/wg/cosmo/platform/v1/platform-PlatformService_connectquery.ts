 ...
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetFederatedSubgraphSDLByName
 */
export const getFederatedSubgraphSDLByName: UnaryFunctionsWithHooks<GetFederatedSubgraphSDLByNameRequest, GetFederatedSubgraphSDLByNameResponse> = {   ...$queryService.getFederatedSubgraphSDLByName,  ...createUnaryHooks($queryService.getFederatedSubgraphSDLByName)};
