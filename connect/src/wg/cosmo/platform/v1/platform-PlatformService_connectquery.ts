...
/**
 * GetDeliveryDetails retrieves details for a particular webhook
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetDeliveryDetails
 */
export const getDeliveryDetails = {
  localName: "getDeliveryDetails",
  name: "GetDeliveryDetails",
  kind: MethodKind.Unary,
  I: GetDeliveryDetailsRequest,
  O: GetDeliveryDetailsResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
