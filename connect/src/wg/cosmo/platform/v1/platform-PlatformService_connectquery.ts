 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.EnableGraphPruningForTheNamespace
 */
export const enableGraphPruningForTheNamespace = {
  localName: "enableGraphPruningForTheNamespace",
  name: "EnableGraphPruningForTheNamespace",
  kind: MethodKind.Unary,
  I: EnableGraphPruningForTheNamespaceRequest,
  O: EnableGraphPruningForTheNamespaceResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
