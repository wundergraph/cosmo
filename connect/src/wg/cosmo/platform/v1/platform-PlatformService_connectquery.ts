 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOperationDetailPage
 */
export const getOperationDetailPage = {
  localName: "getOperationDetailPage",
  name: "GetOperationDetailPage",
  kind: MethodKind.Unary,
  I: GetOperationDetailPageRequest,
  O: GetOperationDetailPageResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
