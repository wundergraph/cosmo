 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOrganizationSubscription
 */
export const getOrganizationSubscription = {
  localName: "getOrganizationSubscription",
  name: "GetOrganizationSubscription",
  kind: MethodKind.Unary,
  I: GetOrganizationSubscriptionRequest,
  O: GetOrganizationSubscriptionResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
