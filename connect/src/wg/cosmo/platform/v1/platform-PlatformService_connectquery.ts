...
export const PlatformService = {
  ...
  methods: {
     ...
     *
     * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOrganization
     */
    getOrganization: {
 ...
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetOrganization
 */
export const getOrganization: UnaryFunctionsWithHooks<GetOrganizationRequest, GetOrganizationResponse> = {   ...$queryService.getOrganization,  ...createUnaryHooks($queryService.getOrganization)};
