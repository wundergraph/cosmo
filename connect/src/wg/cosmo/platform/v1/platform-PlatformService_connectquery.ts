 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.EnableCacheWarmer
 */
export const enableCacheWarmer = {
  localName: "enableCacheWarmer",
  name: "EnableCacheWarmer",
  kind: MethodKind.Unary,
  I: EnableCacheWarmerRequest,
  O: EnableCacheWarmerResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
