 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetProposalsOfFederatedGraph
 */
export const getProposalsOfFederatedGraph = {
  localName: "getProposalsOfFederatedGraph",
  name: "GetProposalsOfFederatedGraph",
  kind: MethodKind.Unary,
  I: GetProposalsOfFederatedGraphRequest,
  O: GetProposalsOfFederatedGraphResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetChecksOfProposal
 */
export const getChecksOfProposal = {
  localName: "getChecksOfProposal",
  name: "GetChecksOfProposal",
  kind: MethodKind.Unary,
  I: GetChecksOfProposalRequest,
  O: GetChecksOfProposalResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
