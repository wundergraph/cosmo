 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.RetirePersistedOperation
 */
export const retirePersistedOperation = {
  localName: "retirePersistedOperation",
  name: "RetirePersistedOperation",
  kind: MethodKind.Unary,
  I: RetirePersistedOperationRequest,
  O: RetirePersistedOperationResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
