 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetNamespaceSSOMapping
 */
export const getNamespaceSSOMapping = {
  localName: "getNamespaceSSOMapping",
  name: "GetNamespaceSSOMapping",
  kind: MethodKind.Unary,
  I: GetNamespaceSSOMappingRequest,
  O: GetNamespaceSSOMappingResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.UpdateNamespaceSSOMapping
 */
export const updateNamespaceSSOMapping = {
  localName: "updateNamespaceSSOMapping",
  name: "UpdateNamespaceSSOMapping",
  kind: MethodKind.Unary,
  I: UpdateNamespaceSSOMappingRequest,
  O: UpdateNamespaceSSOMappingResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
