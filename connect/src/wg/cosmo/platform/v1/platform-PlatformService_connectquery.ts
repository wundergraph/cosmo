...
/**
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.CheckMultipleSubgraphSchemas
 */
export const checkMultipleSubgraphSchemas = {
  localName: "checkMultipleSubgraphSchemas",
  name: "CheckMultipleSubgraphSchemas",
  kind: MethodKind.Unary,
  I: CheckMultipleSubgraphSchemasRequest,
  O: CheckMultipleSubgraphSchemasResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
