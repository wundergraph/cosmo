 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetFederatedGraph
 */
export const getFederatedGraph = {
  localName: "getFederatedGraph",
  name: "GetFederatedGraph",
  kind: MethodKind.Unary,
  I: GetFederatedGraphRequest,
  O: GetFederatedGraphResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetSubgraph
 */
export const getSubgraph = {
  localName: "getSubgraph",
  name: "GetSubgraph",
  kind: MethodKind.Unary,
  I: GetSubgraphRequest,
  O: GetSubgraphResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
