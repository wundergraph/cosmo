...
export const PlatformService = {
  ...
  methods: {
    ...
    /**
     * CreateOperationOverride marks if the given set of changes from a check should be considered safe for an operation
     *
     * @generated from rpc wg.cosmo.platform.v1.PlatformService.CreateOperationOverride
     */
    createOperationOverride: {
      name: "CreateOperationOverride",
      I: CreateOperationOverrideRequest,
      O: CreateOperationOverrideResponse,
      kind: MethodKind.Unary,
    },
    /**
     * RemoveOperationOverride removes changes for a check which were earlier marked as safe
     *
     * @generated from rpc wg.cosmo.platform.v1.PlatformService.RemoveOperationOverride
     */
    removeOperationOverride: {
      name: "RemoveOperationOverride",
      I: RemoveOperationOverrideRequest,
      O: RemoveOperationOverrideResponse,
      kind: MethodKind.Unary,
    },
    /**
    ...
    /**
     * UpdateAISettings updates ai setting of the organization
     *
     * @generated from rpc wg.cosmo.platform.v1.PlatformService.UpdateAISettings
     */
    updateAISettings: {
 ...
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.CreateOperationOverride
 */
export const createOperationOverride: UnaryFunctionsWithHooks<CreateOperationOverrideRequest, CreateOperationOverrideResponse> = {   ...$queryService.createOperationOverride,  ...createUnaryHooks($queryService.createOperationOverride)};
 ...
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.RemoveOperationOverride
 */
export const removeOperationOverride: UnaryFunctionsWithHooks<RemoveOperationOverrideRequest, RemoveOperationOverrideResponse> = {   ...$queryService.removeOperationOverride,  ...createUnaryHooks($queryService.removeOperationOverride)};
 ...
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.UpdateAISettings
 */
export const updateAISettings: UnaryFunctionsWithHooks<UpdateAISettingsRequest, UpdateAISettingsResponse> = {   ...$queryService.updateAISettings,  ...createUnaryHooks($queryService.updateAISettings)};
