 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.GetCacheCohortConfigVersions
 */
export const getCacheCohortConfigVersions = {
  localName: "getCacheCohortConfigVersions",
  name: "GetCacheCohortConfigVersions",
  kind: MethodKind.Unary,
  I: GetCacheCohortConfigVersionsRequest,
  O: GetCacheCohortConfigVersionsResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 * stored percentages.
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.BulkUpdateProposalRolloutPercentages
 */
export const bulkUpdateProposalRolloutPercentages = {
  localName: "bulkUpdateProposalRolloutPercentages",
  name: "BulkUpdateProposalRolloutPercentages",
  kind: MethodKind.Unary,
  I: BulkUpdateProposalRolloutPercentagesRequest,
  O: BulkUpdateProposalRolloutPercentagesResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
 ...
 *
 * @generated from rpc wg.cosmo.platform.v1.PlatformService.TeardownProposalRollout
 */
export const teardownProposalRollout = {
  localName: "teardownProposalRollout",
  name: "TeardownProposalRollout",
  kind: MethodKind.Unary,
  I: TeardownProposalRolloutRequest,
  O: TeardownProposalRolloutResponse,
  service: {
    typeName: "wg.cosmo.platform.v1.PlatformService"
  }
} as const;
