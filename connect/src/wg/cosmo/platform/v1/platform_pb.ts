...
export class SubgraphMinimal extends Message<SubgraphMinimal> {
  ...
  /**
   * @generated from field: string fedGraphId = 4;
   */
  fedGraphId = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "namespace", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "fedGraphId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class GetFederatedGraphsResponse extends Message<GetFederatedGraphsResponse> {
  ...
  /**
   * @generated from field: repeated wg.cosmo.platform.v1.SubgraphMinimal subgraphs = 3;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "subgraphs", kind: "message", T: SubgraphMinimal, repeated: true },
  ]);
