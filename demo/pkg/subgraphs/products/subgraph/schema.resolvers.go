...
func (r *queriesResolver) Shippings(ctx context.Context) ([]*model.Shipping, error) {
	return shippingData, nil
}

// FindShipping is the resolver for the findShipping field.
func (r *queriesResolver) FindShipping(ctx context.Context, id string, trackingNumber string) (*model.Shipping, error) {
