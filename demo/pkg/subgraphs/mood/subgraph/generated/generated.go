...
func (ec *executionContext) field_Mutation_updateMood_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["mood"]; ok {
		...
		arg1, err = ec.unmarshalNMood2githubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐMood(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNMood2githubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋmoodᚋsubgraphᚋmodelᚐMood(ctx context.Context, v interface{}) (model.Mood, error) {
	var res model.Mood
