...
func (ec *executionContext) field_Mutation_updateAvailability_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Mutation_updateAvailability_argsEmployeeID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["employeeID"] = arg0
	arg1, err := ec.field_Mutation_updateAvailability_argsIsAvailable(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_updateAvailability_argsEmployeeID(
	ctx context.Context,
	rawArgs map[string]any,
) (int, error) {
...
func (ec *executionContext) field_Mutation_updateAvailability_argsIsAvailable(
	ctx context.Context,
	rawArgs map[string]any,
) (bool, error) {
	if _, ok := rawArgs["isAvailable"]; !ok {
		var zeroVal bool
		return zeroVal, nil
	}
...
func (ec *executionContext) _Entity_findEmployeeByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNEmployee2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋavailabilityᚋsubgraphᚋmodelᚐEmployee(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNEmployee2githubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋavailabilityᚋsubgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v model.Employee) graphql.Marshaler {
	return ec._Employee(ctx, sel, &v)
}

func (ec *executionContext) marshalNEmployee2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋavailabilityᚋsubgraphᚋmodelᚐEmployee(ctx context.Context, sel ast.SelectionSet, v *model.Employee) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
