...
var Employees = []*projects.Employee{
	...
	{
		Id:             4,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[3]}},
	...
	{
		Id:             7,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[2], ServiceProjects[1]}},
