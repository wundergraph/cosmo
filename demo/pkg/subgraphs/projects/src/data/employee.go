...
var Employees = []*projects.Employee{
	{
		Id:             1,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[0], ServiceProjects[3]}},
		...
		Skills:         &projects.ListOfString{Items: []string{"AWS", "Kubernetes", "Infrastructure"}}, // nullable list of nullable skills
		Certifications: &projects.ListOfString{Items: []string{"AWS Solutions Architect", "CKA"}},      // nullable list of non-nullable certifications
		ProjectHistory: GetProjectHistoryByEmployeeId(1),                                               // populated project history
	},
	{
		Id:             2,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[0], ServiceProjects[1], ServiceProjects[4]}},
		...
		Certifications: &projects.ListOfString{Items: []string{"GCP Professional Cloud Architect"}},
		ProjectHistory: GetProjectHistoryByEmployeeId(2),
	},
	{
		Id:             3,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[0], ServiceProjects[5]}},
		AssignedTasks:  GetAssignedTasksByEmployeeId(3),
		CompletedTasks: GetCompletedTasksByEmployeeId(3),
		// New fields
		Skills:         &projects.ListOfString{Items: []string{"Networking", "Security", "Monitoring"}},
		Certifications: &projects.ListOfString{Items: []string{"CISSP", "CCNA"}},
		ProjectHistory: GetProjectHistoryByEmployeeId(3),
	},
	{
		Id:             4,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[1]}},
		AssignedTasks:  GetAssignedTasksByEmployeeId(4),
		CompletedTasks: GetCompletedTasksByEmployeeId(4),
		Skills:         &projects.ListOfString{Items: []string{"Java", "Spring", "Microservices"}},
		Certifications: &projects.ListOfString{Items: []string{"Oracle Certified Professional Java SE"}},
	...
	},
	{
		...
		Skills:         &projects.ListOfString{Items: []string{"Python", "Machine Learning", "Data Science"}},
		Certifications: &projects.ListOfString{Items: []string{"Google Professional Data Engineer"}},
		ProjectHistory: GetProjectHistoryByEmployeeId(5),
	},
	{
		Id:             6,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[2]}},
		AssignedTasks:  GetAssignedTasksByEmployeeId(6),
		CompletedTasks: GetCompletedTasksByEmployeeId(6),
		Skills:         &projects.ListOfString{Items: []string{"TensorFlow", "PyTorch", "Computer Vision"}},
		Certifications: &projects.ListOfString{Items: []string{"AWS Certified Machine Learning"}},
	...
	},
	{
		...
		Skills:         &projects.ListOfString{Items: []string{"System Architecture", "Distributed Systems"}},
		Certifications: &projects.ListOfString{Items: []string{"TOGAF 9 Certified"}},
	...
	},
	{
		...
		Skills:         &projects.ListOfString{Items: []string{"Node.js", "GraphQL", "REST APIs"}},
		Certifications: &projects.ListOfString{Items: []string{"MongoDB Certified Developer"}},
		ProjectHistory: GetProjectHistoryByEmployeeId(8),
	},
	{
		Id:             9,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[3], ServiceProjects[4]}},
		AssignedTasks:  GetAssignedTasksByEmployeeId(9),
		CompletedTasks: GetCompletedTasksByEmployeeId(9),
		Skills:         &projects.ListOfString{Items: []string{"DevOps", "Terraform", "Ansible"}},
		Certifications: &projects.ListOfString{Items: []string{"HashiCorp Certified Terraform Associate"}},
		ProjectHistory: GetProjectHistoryByEmployeeId(9),
	},
	{
		Id:             10,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[4]}},
		AssignedTasks:  GetAssignedTasksByEmployeeId(10),
		CompletedTasks: GetCompletedTasksByEmployeeId(10),
		Skills:         &projects.ListOfString{Items: []string{"Backend", "Go", "Docker"}},
		Certifications: &projects.ListOfString{Items: []string{"HashiCorp Certified Terraform Associate"}},
		ProjectHistory: GetProjectHistoryByEmployeeId(10),
	},
	{
		Id:             11,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[5]}},
		AssignedTasks:  GetAssignedTasksByEmployeeId(11),
		CompletedTasks: GetCompletedTasksByEmployeeId(11),
		Skills:         &projects.ListOfString{Items: []string{"Frontend", "React", "TypeScript"}},
		Certifications: nil,
		ProjectHistory: GetProjectHistoryByEmployeeId(11),
	},
	{
		Id:             12,
		Projects:       &projects.ListOfProject{Items: []*projects.Project{ServiceProjects[6]}},
