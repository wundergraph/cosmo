...
import (
	...
	"github.com/wundergraph/cosmo/demo/pkg/subgraphs/cachetest/articlesmeta/subgraph/model"
)
...
func (ec *executionContext) _Entity_findArticleByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNArticle2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋcachetestᚋarticlesmetaᚋsubgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2githubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋcachetestᚋarticlesmetaᚋsubgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v model.Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚖgithubᚗcomᚋwundergraphᚋcosmoᚋdemoᚋpkgᚋsubgraphsᚋcachetestᚋarticlesmetaᚋsubgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
