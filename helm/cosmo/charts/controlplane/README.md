...
| ingress.tls | list | `[]` |  |
| jobs | object | `{"activateOrganization":{"additionalLabels":{},"enabled":false,"id":"123","slug":"foo"},"cleanupOldData":{"additionalLabels":{},"enabled":true,"schedule":"0 0 1 * *"},"clickhouseMigration":{"additionalLabels":{}},"databaseMigration":{"additionalLabels":{}},"deactivateOrganization":{"additionalLabels":{},"enabled":false,"id":"123","reason":"","slug":"foo"},"deleteUser":{"additionalLabels":{},"email":"foo@wundergraph.com","enabled":false,"id":"123"},"seedOrganization":{"additionalLabels":{}}}` | Configure jobs to be executed in the control plane |
...
| jobs.cleanupOldData | object | `{"additionalLabels":{},"enabled":true,"schedule":"0 0 1 * *"}` | Scheduled CronJob to delete data (schema checks, audit logs, etc.) older than 90 days |
| jobs.cleanupOldData.additionalLabels | object | `{}` | Adds additional labels to the job |
| jobs.cleanupOldData.enabled | bool | `true` | Enables the cleanup CronJob |
| jobs.cleanupOldData.schedule | string | `"0 0 1 * *"` | Cron schedule (default: 1st of every month at midnight UTC) |
