...
const TableWrapper = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('scrollbar-custom w-full overflow-auto rounded-md border', className)}
      {...props}
    ></div>
  ),
);
...
export { Table, TableWrapper, TableHeader, TableBody, TableFooter, TableHead, TableRow, TableCell, TableCaption };
