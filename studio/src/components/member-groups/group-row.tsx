  ...
  return (
    <TableRow>
      <TableCell className="space-x-3">
        ...
        {group.builtin && (
          <Tooltip>
            ...
            <TooltipContent>Built-in groups cannot be modified or deleted.</TooltipContent>
          </Tooltip>
        )}
      </TableCell>
      ...
      <TableCell className="text-center">
        {isAdmin ? (
          <Button variant="link" className="h-auto gap-x-2 whitespace-nowrap" onClick={() => onSelect(true)}>
            {group.membersCount}
          </Button>
        ) : (
          group.membersCount
          ...
          {!group.builtin && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => onSelect(false)}>Edit</DropdownMenuItem>
