      ...
      {errorMessage ? (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            ...
            {deliveryId && (
              <p className="mt-4">
                <Button variant="link" className="h-auto p-0" onClick={() => setSelectedDeliveryId(deliveryId)}>
        ...
        <EmptyState
          ...
          actions={
            deliveryId && <Button onClick={() => setSelectedDeliveryId(deliveryId)}>View delivery details</Button>
          }
        />
      )}
