...
export const calURL = 'https://cal.com/stefan-avram-wundergraph/wundergraph-introduction';
export const lintCategories = [
  {
    title: 'Naming Convention',
    description: "Configure these rules to enforce naming convention across this namespace's schemas.",
    rules: [
      {
      ...
      },
      {
        ...
        description: "An interface type's name should never be prefixed with 'Interface'.",
      },
      {
        name: 'SHOULD_NOT_HAVE_INTERFACE_SUFFIX',
        description: "An interface type's name should never be suffixed with 'Interface'.",
      },
      {
  ...
  },
  {
    ...
    description: 'Configure these rules to enforce the arrangement of types, fields... in the schema.',
    rules: [
      {
        name: 'ORDER_FIELDS',
  ...
  {
    title: 'Others',
    description: 'Configure these rules to define conventions throughout our schema.',
    rules: [
      {
        name: 'ALL_TYPES_REQUIRE_DESCRIPTION',
        description: 'Should describe all the type definitions with a description.',
      },
      {
        name: 'DISALLOW_CASE_INSENSITIVE_ENUM_VALUES',
        description: 'Enum values should eliminate duplicates by disallowing case insensitivity.',
      },
      {
...
export const graphPruningRules = [
  ...
  },
  {
    ...
    description: 'Returns all the deprecated fields that need to be removed from the schema.',
  },
  {
