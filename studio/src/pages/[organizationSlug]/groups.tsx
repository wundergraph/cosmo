          ...
          <div className="flex h-full flex-col gap-y-4">
            <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
              <p className="text-sm text-muted-foreground">
                ...
                <a target="_blank" rel="noreferrer" href={docsBaseURL + '/studio/groups'} className="text-primary">
                  Learn more.
                </a>
              </p>
            </div>
...
GroupsPage.getLayout = (page) => {
  return getDashboardLayout(page, 'Groups', 'Manage all the groups of your organization.', null, <GroupsToolbar />);
};
