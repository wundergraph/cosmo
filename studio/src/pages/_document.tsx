...
const getCustomScripts = (): { src: string; id: string; inline?: boolean }[] | undefined => {
  try {
    return process.env.CUSTOM_HEAD_SCRIPTS ? JSON.parse(process.env.CUSTOM_HEAD_SCRIPTS) : [];
  } catch {
    // ignore
  }
};
      ...
      <body>
        ...
        {scripts?.map((script, i) =>
          script.inline ? (
            ...
            <Script key={i} id={script.id} src={script.src} strategy="afterInteractive" />
          ),
        )}
