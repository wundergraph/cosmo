...
generate-go:
	...
	rm -rf terraform-provider/gen && buf generate --path proto/wg/cosmo/common --path proto/wg/cosmo/node --path proto/wg/cosmo/notifications --path proto/wg/cosmo/platform --template buf.terraform-provider.go.gen.yaml
